...
export const MODELS = [
  ...
  { name: "GPT-5.6 Sol", provider: "OpenAI", released: "2026/07", type: "Frontier", arch: "MoE (reported)", params: "\u2014", active: "\u2014",
    attn: "Undisclosed", modality: "Text + image + audio", context: 1000000, maxOut: 128000, license: "Proprietary", open: false, intel: 61, coding: 78, agentic: 58, training: null,
  ...
  { name: "Grok 4.6", provider: "xAI", released: "2026/08", type: "Frontier", arch: "Undisclosed", params: "\u2014", active: "\u2014",
    attn: "Undisclosed", modality: "Text + image", context: 500000, maxOut: null, license: "Proprietary", open: false, intel: 61, coding: null, agentic: 59, training: null,
  ...
  { name: "Muse Spark 1.2", provider: "Meta", released: "2026/08", type: "Frontier", arch: "Undisclosed", params: "—", active: "—",
    attn: "Undisclosed", modality: "Text + image + video + audio", context: 1048576, maxOut: null, license: "Proprietary", open: false, intel: 57, coding: null, agentic: 49, training: null,
  ...
  { name: "Qwen3.8 Max", provider: "Alibaba", released: "2026/07", type: "Frontier", arch: "Sparse MoE", params: "2.4T", active: "95B",
    attn: "Gated DeltaNet + gated attn", modality: "Text + image + video", context: 1000000, maxOut: 131072, license: "Proprietary (API)", open: false, intel: 58, coding: null, agentic: 58, training: null,
  ...
  { name: "GPT-5 mini", provider: "OpenAI", released: "2025/08", type: "Mid", arch: "MoE (reported)", params: "—", active: "—",
    attn: "Undisclosed", modality: "Text + image", context: 400000, maxOut: 64000, license: "Proprietary", open: false, intel: 32, coding: 16, agentic: null, training: null,
  ...
  { name: "Gemini 3.7 Flash", provider: "Google", released: "2026/08", type: "Mid", arch: "MoE (reported)", params: "—", active: "—",
    attn: "Sparse + long-context", modality: "Text + image + video + audio", context: 1000000, maxOut: 64000, license: "Proprietary", open: false, intel: 56, coding: null, agentic: 45, training: null,
  ...
  { name: "Gemini 3.6 Flash", provider: "Google", released: "2026/07", type: "Mid", arch: "MoE (reported)", params: "—", active: "—",
    attn: "Sparse + long-context", modality: "Text + image + video + audio", context: 1000000, maxOut: 64000, license: "Proprietary", open: false, intel: 52, coding: null, agentic: 41, training: null,
  ...
  { name: "Muse Glimmer", provider: "Meta", released: "2026/08", type: "SLM", arch: "Dense", params: "30B", active: "30B",
    attn: "Sliding-window + global", modality: "Text + image", context: 131072, maxOut: null, license: "Apache 2.0", open: true, intel: 35, coding: null, agentic: 23, training: null,
  ...
  { name: "Qwen3.5 (0.8B)", provider: "Alibaba", released: "2026/02", type: "SLM", arch: "Dense", params: "0.8B", active: "0.8B",
    attn: "Gated DeltaNet + gated attn", modality: "Text + image + video", context: 262144, maxOut: 8192, license: "Apache 2.0", open: true, intel: 5, coding: 1, agentic: null, training: [{ label: "Pre-training", tokens: null, detail: "Alibaba published no Qwen3.5 technical report. The only official source is the Qwen3.5 blog (\"Towards Native Multimodal Agents\", Feb 2026), which names the training stages but discloses no token budget for any of them — so no figure is shown here rather than borrowing the previous generation's." }, { label: "Post-training", tokens: null, detail: "SFT + RL; thinking/non-thinking modes." }],
