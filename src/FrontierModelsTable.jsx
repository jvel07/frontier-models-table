...
export const MODELS = [
  ...
  { name: "Sarvam 105B", provider: "Sarvam AI", released: "2026/03", type: "Mid", arch: "Sparse MoE", params: "105B", active: "10.3B",
    attn: "MLA (Multi-head Latent Attn)", modality: "Text", context: 131072, maxOut: null, license: "Apache 2.0", open: true, intel: 12, intelVersion: "4.1", codingAgent: null, codingAgentVia: null, agentic: null,
    training: [
  ...
  { name: "Sarvam 30B", provider: "Sarvam AI", released: "2026/03", type: "SLM", arch: "Sparse MoE", params: "30B", active: "2.4B",
    attn: "Grouped-query attention", modality: "Text", context: 131072, maxOut: null, license: "Apache 2.0", open: true, intel: 6, intelVersion: "4.1", codingAgent: null, codingAgentVia: null, agentic: null,
    training: [
  ...
  { name: "Kimi K2.6", provider: "Moonshot", released: "2026/04", type: "Frontier", arch: "Sparse MoE", params: "1T", active: "32B",
    attn: "MLA (Multi-head Latent Attn)", modality: "Text + image", context: 256000, maxOut: null, license: "Modified MIT", open: true, intel: 45, intelVersion: "4.1", codingAgent: 33, codingAgentVia: "Claude Code", codingAgentVersion: "1.3", agentic: 31,
  ...
  { name: "GLM-5.1", provider: "Zhipu", released: "2026/04", type: "Frontier", arch: "Sparse MoE", params: "744B", active: "40B",
    attn: "MLA + DeepSeek Sparse Attn", modality: "Text + image", context: 202752, maxOut: null, license: "MIT", open: true, intel: 41, intelVersion: "4.1", codingAgent: 36, codingAgentVia: "Claude Code", codingAgentVersion: "1.3", agentic: 31, training: null,
  ...
  { name: "Gemma 4 26B-A4B", provider: "Google", released: "2026/04", type: "SLM", arch: "Sparse MoE", params: "25.2B", active: "3.8B",
    attn: "Sliding-window + global", modality: "Text + image + video", context: 256000, maxOut: 8192, license: "Apache 2.0", open: true, intel: 26, intelVersion: "4.1", codingAgent: null, codingAgentVia: null, agentic: 11, training: null,
  ...
  { name: "Muse Spark", provider: "Meta", released: "2026/04", type: "Frontier", arch: "Undisclosed", params: "—", active: "—",
    attn: "Undisclosed", modality: "Text + image + audio", context: 262144, maxOut: null, license: "Proprietary", open: false, intel: 44, intelVersion: "4.1", codingAgent: null, codingAgentVia: null, agentic: null, training: null,
  ...
  { name: "Opus 5", provider: "Anthropic", released: "2026/07", type: "Frontier", arch: "Undisclosed", params: "\u2014", active: "\u2014",
    attn: "Undisclosed", modality: "Text + image", context: 1000000, maxOut: 128000, license: "Proprietary", open: false, intel: 51, intelVersion: "4.3", codingAgent: 60, codingAgentVia: "Claude Code", codingAgentVersion: "1.5", agentic: 59, vision: 85, training: null,
    note: "Anthropic's new Opus-tier flagship, shipped 24 July 2026, succeeding Opus 4.8. Adds an 'xhigh' reasoning-effort mode and a Fast mode (~2.5x speed at 2x price). Positioned just below Fable 5 \u2014 reported near-Fable intelligence at roughly half the cost. Architecture, parameters and training remain undisclosed, as with the rest of the Claude line. Artificial Analysis framed it as 'Fable 5 level intelligence at a lower cost per task'; the leaderboard now carries its own rows per reasoning effort, and the figures here are the max-effort variant." },
  { name: "Sonnet 5", provider: "Anthropic", released: "2026/06", type: "Mid", arch: "Undisclosed", params: "\u2014", active: "\u2014",
    attn: "Undisclosed", modality: "Text + image", context: 1000000, maxOut: 64000, license: "Proprietary", open: false, intel: 55, intelVersion: "4.1", codingAgent: null, codingAgentVia: null, agentic: 50, training: null,
  ...
  { name: "GPT-6 Astra", provider: "OpenAI", released: "2026/09", type: "Frontier", arch: "Undisclosed", params: "\u2014", active: "\u2014",
    attn: "Undisclosed", modality: "Text + image", context: 1050000, maxOut: 128000, license: "Proprietary", open: false, intel: 53, intelVersion: "4.3", codingAgent: 62, codingAgentVia: "Codex", codingAgentVersion: "1.5", agentic: null, vision: 87, training: null,
    note: "The first GPT-6, shipped September 2026, and OpenAI's own docs name it the flagship for complex reasoning and coding, with GPT-5.6 Terra and Luna kept below it on cost. The window is the odd number here: 1,050,000 tokens against a 128K maximum output, where the whole GPT-5.6 line sits on a round 1M. Modalities narrow rather than widen against that line \u2014 text and image in, text out, with audio and video explicitly unsupported, where GPT-5.6 Sol takes audio too. Knowledge cutoff is 30 April 2026. Architecture is undisclosed and this row says so rather than carrying the \"MoE (reported)\" the GPT-5.x rows carry: that label rests on reporting about those models, and nothing equivalent has been published for GPT-6. Artificial Analysis rates it second on its board at 53 under Index v4.3, and publishes the highest MMMU-Pro figure it has for any model, 87." },
  { name: "GPT-5.6 Sol", provider: "OpenAI", released: "2026/07", type: "Frontier", arch: "MoE (reported)", params: "\u2014", active: "\u2014",
    attn: "Undisclosed", modality: "Text + image + audio", context: 1000000, maxOut: 128000, license: "Proprietary", open: false, intel: 47, intelVersion: "4.3", codingAgent: 55, codingAgentVia: "Codex", codingAgentVersion: "1.5", agentic: 58, vision: 83, training: null,
  ...
  { name: "GPT-5.6 Terra", provider: "OpenAI", released: "2026/07", type: "Frontier", arch: "MoE (reported)", params: "\u2014", active: "\u2014",
    attn: "Undisclosed", modality: "Text + image", context: 1000000, maxOut: 128000, license: "Proprietary", open: false, intel: 42, intelVersion: "4.3", codingAgent: 62, codingAgentVia: "Codex", codingAgentVersion: "1.3", agentic: 50, vision: 81, training: null,
  ...
  { name: "GPT-5.6 Luna", provider: "OpenAI", released: "2026/07", type: "Mid", arch: "MoE (reported)", params: "\u2014", active: "\u2014",
    attn: "Undisclosed", modality: "Text + image", context: 1000000, maxOut: 128000, license: "Proprietary", open: false, intel: 38, intelVersion: "4.3", codingAgent: 59, codingAgentVia: "Codex", codingAgentVersion: "1.3", agentic: 47, vision: 79, training: null,
  ...
  { name: "Grok 4.6", provider: "xAI", released: "2026/08", type: "Frontier", arch: "Undisclosed", params: "\u2014", active: "\u2014",
    attn: "Undisclosed", modality: "Text + image", context: 500000, maxOut: null, license: "Proprietary", open: false, intel: 44, intelVersion: "4.3", codingAgent: 47, codingAgentVia: "Grok Build", codingAgentVersion: "1.5", agentic: 59, training: null,
  ...
  { name: "Grok 4.5", provider: "xAI", released: "2026/07", type: "Frontier", arch: "MoE (reported)", params: "\u2014", active: "\u2014",
    attn: "Sparse + long-context", modality: "Text + image", context: 500000, maxOut: null, license: "Proprietary", open: false, intel: 56, intelVersion: "4.1", codingAgent: 64, codingAgentVia: "Grok Build", codingAgentVersion: "1.3", agentic: 49, training: null,
  ...
  { name: "Muse Spark 1.1", provider: "Meta", released: "2026/07", type: "Frontier", arch: "Undisclosed", params: "\u2014", active: "\u2014",
    attn: "Undisclosed", modality: "Text + image + video + audio", context: 1048576, maxOut: null, license: "Proprietary", open: false, intel: 53, intelVersion: "4.1", codingAgent: 54, codingAgentVia: "Opencode", codingAgentVersion: "1.3", agentic: 40, training: null,
  ...
  { name: "Muse Spark 1.2", provider: "Meta", released: "2026/08", type: "Frontier", arch: "Undisclosed", params: "—", active: "—",
    attn: "Undisclosed", modality: "Text + image + video + audio", context: 1048576, maxOut: null, license: "Proprietary", open: false, intel: 57, intelVersion: "4.1", codingAgent: 61, codingAgentVia: "tbh", codingAgentVersion: "1.3", agentic: 49, training: null,
  ...
  { name: "Qwen3.8-Flash-Next", provider: "Alibaba", released: "2026/08", type: "Frontier", arch: "Sparse MoE", params: "180B", active: "6B",
    attn: "Gated DeltaNet + QSA (36:12 layers)", modality: "Text + image", context: 262144, maxOut: null, license: "Qwen Community 1.0", open: true, intel: null, codingAgent: null, codingAgentVia: null, agentic: null, vision: null,
    training: [
      { label: "Pre-training", tokens: null, detail: "No token budget is published. What Alibaba does describe is the optimiser split: Muon and AdamW each applied to the weight categories they suit, with batch-size warmup dropped so training starts at the target batch size. It credits refitted scaling laws for making that safe at a higher learning rate, and reports the effect as fewer optimiser steps to convergence rather than as a quality gain." },
      { label: "Post-training", tokens: null, detail: "Named as a stage with no detail, budget or method published." },
    ],
    note: "Alibaba labels this an experimental preview of the architecture meant to underpin Qwen4, so read every figure as provisional. Four things change at once. Attention pairs Gated DeltaNet with Qwen Sparse Attention, which selects micro-blocks rather than individual tokens on a budget of 512 blocks or 2048 tokens, in a 3:1 layout repeated twelve times over 48 layers. A gated residual replaces the plain one, mixing four branches through a rank-320 bottleneck under a data-dependent read gate. Parameters are scaled through an n-gram embedding of 20M bigram and trigram entries at layer two, which is why the total splits as 125B of model, 51B of that embedding and 4B of MTP head while only 6B fires per token. The MoE is unusually fine-grained even for Qwen: 512 experts, 10 routed plus 1 shared. Weights are the 262K-context preview under a community licence; the 1M-context Qwen3.8-Flash sold through Qwen Cloud is a different artefact and is not this row. Artificial Analysis has not rated it, so every index column is blank." },
  { name: "Qwen3.8 Max", provider: "Alibaba", released: "2026/07", type: "Frontier", arch: "Sparse MoE", params: "2.4T", active: "95B",
    attn: "Gated DeltaNet + gated attn", modality: "Text + image + video", context: 1000000, maxOut: 131072, license: "Proprietary (API)", open: false, intel: 45, intelVersion: "4.3", codingAgent: 43, codingAgentVia: "Claude Code", codingAgentVersion: "1.5", agentic: 58, vision: 83, training: null,
  ...
  { name: "Kimi K3", provider: "Moonshot", released: "2026/07", type: "Frontier", arch: "Sparse MoE", params: "2.8T", active: "104.2B",
    attn: "KDA + full attn (69:24 layers)", modality: "Text + image + video", context: 1048576, maxOut: 131072, license: "Kimi K3 License", open: true, intel: 44, intelVersion: "4.3", codingAgent: 52, codingAgentVia: "Kimi Code CLI", codingAgentVersion: "1.5", agentic: 54, vision: 81,
    training: [
  ...
  { name: "GLM-5.3-Flash", provider: "Zhipu", released: "2026/08", type: "Frontier", arch: "Sparse MoE", params: "320B", active: "18B",
    attn: "KDA + DSA (34:11 layers)", modality: "Text + image", context: 1000000, maxOut: 128000, license: "MIT", open: true, intel: 42, intelVersion: "4.3", codingAgent: null, codingAgentVia: null, agentic: 58, vision: null,
    training: [
      { label: "Pre-training", tokens: "30T", detail: "A new base model rather than a re-post-trained one \u2014 the point of separation from GLM-5.3, which reuses 5.2's base. Z.ai describes the architecture and the training recipe as redesigned together around capability per unit of compute, and pairs them with manifold-constrained hyper-connections in place of the plain residual stream. The corpus is multimodal from the start rather than a text model with vision added afterwards.",
        curriculum: "Z.ai gives one figure for the whole corpus and calls it multimodal; it publishes no domain split, no per-modality share and no sampling rates, so none are recorded here." },
      { label: "Post-training", tokens: null, detail: "No token budget or stage breakdown published. The card reports the result rather than the recipe: ahead of GLM-5.2 across its benchmark set at roughly a tenth of the price, and close to Claude Opus 4.8 on coding and agentic work." },
    ],
    note: "The first natively multimodal model in the GLM-5 line, and the first in the series to interleave two kinds of attention: 34 of its 45 layers are linear KDA and the other 11 are DeepSeek Sparse Attention, one exact layer every fourth. That is what pays for a 1M window at 18B active out of 320B total. The attention layers carry no rotary component at all \u2014 qk_rope_head_dim is 0 in the config, with the full 256 dimensions unrotated \u2014 so position comes from the linear layers' recurrent state and the sparse layers' indexer rather than from RoPE. 288 routed experts fire 8 per token beside 1 shared, the first three layers are dense, and a one-layer MTP head ships in the weights. Reasoning effort is exposed as low, high and max, defaulting to max, which is the setting the published figures use and the one recorded here." },
  { name: "Ling 3.0 flash", provider: "Ant Group", released: "2026/08", type: "Frontier", arch: "Sparse MoE", params: "124B", active: "5.1B",
    attn: "KDA + MLA (5:1 layers)", modality: "Text", context: 262144, maxOut: null, license: "MIT", open: true, intel: null, codingAgent: null, codingAgentVia: null, agentic: null, vision: null,
    training: [
      { label: "Pre-training", tokens: null, detail: "No token budget published. The architectural claim is the one worth recording: the hybrid is native, meaning the 5:1 stacking of KDA and MLA was there from the first pre-training step rather than grafted on by conversion afterwards. Ant Group presents the whole model as an efficiency argument against its own previous flagship \u2014 124B total and 5.1B active are roughly 12% and 8% of the 1T-class Ring-2.6 it is measured against." },
      { label: "Agentic post-training", tokens: null, detail: "Built on more than 10,000 interactive training environments, which the lab describes as closing the loop end to end across coding, general agent use and productivity workflows rather than scoring single turns. No token budget, stage list or reward design is published." },
    ],
    note: "Ant Group's Ling line, and the clearest published case of a hybrid that was designed as one rather than converted into one: five Kimi Delta Attention layers to every one MLA layer, stated as present from the start of pre-training. 42 layers at 2,560 wide with 512 experts firing 8 per token, which is what gets total to 124B and active to 5.1B. The window is 262K with RoPE theta pushed to 6M and half the head dimensions left unrotated. A one-layer MTP head ships in the weights. MIT. Artificial Analysis has not rated it, so the index columns are blank; the comparisons the lab publishes are against its own previous 1T flagship rather than against other labs." },
  { name: "dots3-note preview", provider: "dots-studio", released: "2026/08", type: "Frontier", arch: "Sparse MoE", params: "280B", active: "16B",
    attn: "Sliding-window + global", modality: "Text + image", context: 524288, maxOut: null, license: "Apache 2.0", open: true, intel: null, codingAgent: null, codingAgentVia: null, agentic: null, vision: null,
    training: [
      { label: "Pre-training", tokens: null, detail: "Nothing published \u2014 no budget, no corpus description, no mixture. The card is a capability and deployment document rather than a training one." },
    ],
    note: "A preview, and the first open-weight model in the dots3 family, so the figures are provisional in the way every preview's are. 280B total against 16B active, and a 512K window \u2014 twice the usual 256K and the longest natively trained context in this table. It gets there the cheap way: of 46 layers only 13 are global, the other 33 are sliding-window, and the KV cache is compressed through an MLA latent besides. RoPE theta is pushed to 80M, an order of magnitude past the 1M-context models here, which is what a window that long costs in rotation frequency. 256 routed experts fire 8 per token beside 1 shared. Apache 2.0. Artificial Analysis has not rated it." },
  { name: "Ornith 1.5 397B", provider: "Ornith", released: "2026/08", type: "Frontier", arch: "Sparse MoE", params: "397B", active: "\u2014",
    attn: "Gated DeltaNet + gated attn", modality: "Text", context: 262144, maxOut: null, license: "MIT", open: true, intel: null, codingAgent: null, codingAgentVia: null, agentic: null, vision: null,
    trainingSource: "The architecture is not Ornith's. Ornith-1.0 was built on top of Qwen3.5 and Gemma 4, and 1.5 extends it, so every structural field in this row \u2014 the 3:1 Gated DeltaNet layout, the 512-expert MoE, the 248,320 vocabulary, the qwen3_5_moe_text model type in its own config \u2014 describes Qwen3.5's design carried forward. What Ornith reports as its own is the training loop below and the weights it produced.",
    training: [
      { label: "Continued pre-training + mid-training", tokens: null, detail: "Inherited from Ornith 1.0, which the lab describes as Qwen3.5 and Gemma 4 taken through additional continued pre-training, mid-training and post-training. No token budget, corpus description or mixture is published for any of those stages, and none is inferred here." },
      { label: "Self-improvement loop (RL)", tokens: null, detail: "The part Ornith presents as its own contribution, and the reason this row exists. Where 1.0 optimised scaffolds and rollouts against a fixed set of human-written tasks, 1.5 also generates the tasks: it writes new training problems, searches for harnesses that solve them, and improves the policy by reinforcement learning over the result. Task generation, scaffold construction and rollout are optimised jointly rather than in sequence. Reward design is described in the lab's blog rather than a paper, and no budget or step count is published." },
    ],
    note: "Read the provenance first: this is Qwen3.5 continued-pretrained and post-trained by someone else, not a model Ornith designed. It is here because the training loop is theirs and is the interesting part \u2014 a self-improvement cycle that writes its own tasks rather than consuming a fixed human-curated set \u2014 and because the result is not marginal: Ornith reports 86.1 on Terminal-Bench 2.1 and 56.0 on DeepSWE against Claude Opus 4.8's 85.0 and 59.0. Treat those as the lab's own numbers; nobody independent has published on it. 397B total under MIT, with no active-parameter count disclosed, so that column stays blank rather than being computed from the expert layout. The native window is 262K, and the card's 1M figure is YaRN scaling applied at serve time, not a trained context. Artificial Analysis has not rated it." },
  { name: "K2 Horizon 375B-A23B", provider: "IFM", released: "2026/09", type: "Frontier", arch: "Sparse MoE", params: "375B", active: "23B",
    attn: "Grouped-query attention", modality: "Text", context: 524288, maxOut: null, license: "Apache 2.0", open: true, intel: 31, intelVersion: "4.3", codingAgent: null, codingAgentVia: null, agentic: null, vision: null,
    training: [
      { label: "Pre-training — Phase 1", tokens: "7.08T", detail: "211,000 steps at an 8K sequence length." },
      { label: "Pre-training — Phase 2", tokens: "8.05T", detail: "240,000 steps at 8K, continued from the Phase 1 checkpoint on what IFM describes as newer and better data. Token budgets are published per stage and cover only the additional training in that stage, so this is 8.05T on top of Phase 1 rather than a cumulative figure." },
      { label: "Mid-training — Stage 1", tokens: "1.09T", detail: "32,500 steps, context extended to 32K." },
      { label: "Mid-training — Stage 2", tokens: "503B", detail: "15,000 steps, context extended to 128K." },
      { label: "Mid-training — Stage 3", tokens: "117B", detail: "3,500 steps, context extended to 512K — the window the model ships with." },
      { label: "Mid-training — Stage 4", tokens: "201B", detail: "6,000 steps at 512K, continued from Stage 3 with the data mix shifted toward agentic and reasoning SFT data." },
      { label: "RL", tokens: null, detail: "Five expert models — knowledge work, instruction following, search, tool use, reasoning — trained from the final mid-training checkpoint at 512K and then merged. IFM states that RL steps and token counts are not reported, and therefore publishes no cumulative total that includes them." },
      { label: "SFT — Phase 1", tokens: "81B", detail: "2,400 steps at 512K, starting from the merged RL checkpoint, for broader domain coverage." },
      { label: "SFT — Phase 2", tokens: "201B", detail: "6,000 steps, continued from Phase 1 on nearly the same data mix." },
      { label: "SFT — Phase 3", tokens: "50B", detail: "1,500 steps on a high-quality subset of the Phase 1 and 2 data, with learning-rate decay." },
    ],
    note: "The most completely documented training run in this table: ten stages published with per-stage step counts, token budgets and sequence lengths, alongside a commitment to release the intermediate checkpoints, the data and the training code. The architecture is conventional by 2026 standards and that looks deliberate — 61 layers with the first three dense, 192 routed experts and one shared with 8 firing per token, grouped-query attention at 48 query heads to 8 KV, and no linear or sparse attention anywhere in the stack. The 512K window is trained rather than scaled at serve time: four mid-training stages walk it from 8K through 32K and 128K to 512K. RL is the one gap and the card marks it as one, which is why the disclosed-token total here stops short of the full run. Artificial Analysis rates it 31 on intelligence under Index v4.3 and publishes no coding-agent or agentic figure, so those columns stay blank. IFM's launch blog could not be reached to verify at the time this row was written, so the model card on Hugging Face is cited instead." },
  { name: "Hy4 preview", provider: "Tencent", released: "2026/08", type: "Frontier", arch: "Sparse MoE", params: "770B", active: "49B",
    attn: "Gated DSA + IndexCache", modality: "Text", context: 1000000, maxOut: null, license: "Apache 2.0", open: true, intel: null, codingAgent: null, codingAgentVia: null, agentic: null, vision: null,
    training: [
      { label: "Pre-training", tokens: null, detail: "No token budget published. Tencent names the three axes it scaled \u2014 model size, context length and training data \u2014 and claims the largest generation-over-generation gain it has measured, but publishes no figure for any of them." },
      { label: "Post-training", tokens: null, detail: "Described as substantially larger than the previous generation's, and as built on data drawn from work done inside Tencent: software engineers, game developers, finance analysts and security teams. The claim is that the training data came from the tasks those teams actually ship rather than from a synthetic proxy for them. No budget, stage list or method is published." },
    ],
    note: "A preview, and the name says so \u2014 Tencent's flagship generation is not finished, and preview figures may not survive to GA. 770B total against 49B active, on a backbone of 78 layers where only the first carries a dense FFN and the other 77 are MoE with 256 routed experts and 1 shared, 8 routed firing per token. A separate 10B multi-token-prediction layer for speculative decoding sits outside that count, which is why the weights on Hugging Face total 780B and this row says 770B: the card's own table is explicitly backbone-only. Attention is gated DeepSeek Sparse Attention on every one of the 78 layers, with an indexer of 32 heads selecting 2,048 blocks, and Tencent's IndexCache reusing those sparse indices across layers rather than recomputing them. The residual stream is replaced by four parallel streams under identity hyper-connections. Apache 2.0, which at this size is unusual. Artificial Analysis has not rated it, so every index column is blank." },
  { name: "GLM-5.3", provider: "Zhipu", released: "2026/08", type: "Frontier", arch: "Sparse MoE", params: "743B", active: "40B",
    attn: "DSA + MLA (IndexShare)", modality: "Text", context: 1000000, maxOut: 128000, license: "GLM-5.3 License", open: true, intel: 45, intelVersion: "4.3", codingAgent: 54, codingAgentVia: "Opencode", codingAgentVersion: "1.5", agentic: 59, training: null,
    trainingSource: "Z.ai describes 5.3 as GLM-5.2's base carried forward through a longer post-training run — harder agent environments, fuller trajectories, stronger verification — rather than a new pre-training run. No token budget is published for either stage, so none is shown.",
    note: "Shipped 14 August 2026, six weeks after 5.2, and deliberately not a new architecture: Z.ai's own framing is that the base is unchanged and the gains come from scaling post-training for long-horizon coding and agentic work. The attention stack and expert layout recorded here are therefore 5.2's. Weights were not published at launch and this row recorded it as closed; zai-org/GLM-5.3 went up on 25 August, so the specs here are now read from its own config.json rather than inferred. They are not under 5.2's MIT terms \u2014 the repo carries a model-specific GLM-5.3 licence \u2014 which is why the earlier refusal to assume MIT carried over mattered. Z.ai's documentation adds that input is text-only, that the window is 1M against a 128K maximum output, and that reasoning can no longer be switched off — the efforts are low, high and max, and a request that disables thinking is rejected. What it does describe of the post-training is environment scaling: reinforcement learning against synthesised long-horizon task environments, with verifiers generated without sight of the reference solution and checked against oracle, no-op and unsolved states before their reward is trusted, keeping 5.2's SAO-with-compaction. Z.ai reports Terminal-Bench 3.0 moving from 4.6 to 28.3 and DeepSWE v1.1 from 46.2 to 66.9 on that basis. Artificial Analysis has since rated it: 45 on intelligence under Index v4.3 and 59 on agentic, from the max-effort rows. The intelligence figure was 60 when this row was first written and is not a regression — AA re-based the index at v4.3, moving every model it re-rated down by a similar margin." },
  { name: "GLM-5.2", provider: "Zhipu", released: "2026/06", type: "Frontier", arch: "Sparse MoE", params: "744B", active: "40B",
    attn: "DSA + MLA (IndexShare)", modality: "Text + image", context: 1000000, maxOut: 128000, license: "MIT", open: true, intel: 53, intelVersion: "4.1", codingAgent: 43, codingAgentVia: "Claude Code", codingAgentVersion: "1.3", agentic: 46, training: null,
  ...
  { name: "Solar Open 2", provider: "Upstage", released: "2026/07", type: "Frontier", arch: "Sparse MoE", params: "250B", active: "15B",
    attn: "Hybrid linear + full", modality: "Text", context: 1000000, maxOut: null, license: "Upstage Solar License", open: true, intel: 37, intelVersion: "4.1", codingAgent: null, codingAgentVia: null, agentic: 28, training: null,
  ...
  { name: "Inkling", provider: "Thinking Machines", released: "2026/07", type: "Frontier", arch: "Sparse MoE", params: "975B", active: "41B",
    attn: "Undisclosed", modality: "Text + image + audio", context: 1000000, maxOut: null, license: "Apache 2.0", open: true, intel: 26, intelVersion: "4.3", codingAgent: null, codingAgentVia: null, agentic: 34, vision: 74, training: null,
  ...
  { name: "Motif 3", provider: "Motif Technologies", released: "2026/08", type: "Frontier", arch: "Sparse MoE", params: "314B", active: "13.2B",
    attn: "GDLA (Grouped Differential Latent Attn)", modality: "Text", context: 262144, maxOut: null, license: "MIT", open: true, intel: 47, intelVersion: "4.1", codingAgent: null, codingAgentVia: null, agentic: 38,
    training: [
      { label: "Pre-training", tokens: "~12.5T", detail: "The technical report gives one budget for the whole of pre-training and does not break it into stages. Training ran at up to a 256K context using window-aware context parallelism, with MXFP8 used selectively for compute and for collective communication, fused kernels to hold memory down, and expert-balancing and numerical-stabilisation measures the report credits for keeping a 384-expert router stable at this scale. The multi-token-prediction head is trained here as an auxiliary objective before being reused for self-speculative decoding at inference. The mHC post-mapping multiplier is annealed from 2 to 1 across pre-training, which the lab describes as limiting how far activation outliers accumulate.",
        curriculum: "Web documents, STEM, code, mathematics and multilingual text, plus corpora the lab gathered for specific domains; Korean, reasoning-heavy material, legal and financial text are called out as deliberately over-weighted relative to a general crawl. No per-domain sampling rates are published, so none are recorded here." },
      { label: "Post-training", tokens: null, detail: "Supervised fine-tuning on general data first, then a set of specialists: six teachers trained with reinforcement learning, plus a seventh for software engineering. Those teachers are folded back into one model by multi-teacher on-policy distillation, so the released weights are a single student rather than a router over experts-by-domain. No token counts are given for any post-training stage." },
    ],
    note: "The general-availability release of Motif 3, superseding the beta below, and the differences are worth reading as a pair: MIT rather than a non-commercial licence, a technical report rather than a model card, and figures the lab now states outright — 314B total, 13.2B active — where the beta only approximated them. The architecture is unchanged and remains entirely in-house: 53 layers with the first two dense, 384 routed experts firing 8 per token beside 1 shared, and Grouped Differential Latent Attention, which puts the asymmetric signal and noise heads of differential attention on top of a latent compressed KV cache and adds a query-dependent output gate. Residual connections are replaced by a doubly-stochastic mix over four parallel streams (mHC), the SiLU gate by a polynomial normalisation whose coefficients are learned per expert, and a one-layer MTP head ships in the weights for self-speculative decoding. Weights download without an access request. Artificial Analysis rates it 47 on intelligence and 38 on agentic, and has published no coding-agent score, so that column stays blank. No diagram here yet: the architecture gallery card covers the beta, and the two are not the same release." },
  { name: "Motif 3 Beta", provider: "Motif Technologies", released: "2026/07", type: "Frontier", arch: "Sparse MoE", params: "~314B", active: "~13B",
    attn: "GDLA (Grouped Differential Latent Attn)", modality: "Text", context: 262144, maxOut: null, license: "Motif non-commercial", open: true, intel: 45, intelVersion: "4.1", codingAgent: null, codingAgentVia: null, agentic: null, training: null,
    note: "A preview checkpoint, and the card says so in its first line — an intermediate release of Motif-3 with the final weights to follow. They have since followed, in August 2026 under MIT, and are the row above; this one records a checkpoint that has already been superseded, and its figures did not all survive the move. Motif describes the design as entirely in-house rather than a re-parameterised open-source stack. 53 layers, the first two dense and the rest sparse, with 384 routed experts firing 8 per token beside 1 shared — ≈314B total at ≈13B active, both given as approximations by the card and not narrowed here. Attention is the lab's own Grouped Differential Latent Attention. The config additionally declares a one-layer multi-token-prediction head for self-speculative decoding, a poly_norm activation and a 128-token sliding window interleaved on a period of four. Nothing is published about how this checkpoint was trained: the technical report describes the final model, so the pipeline rows stay empty rather than borrowing it. Weights download without an access request, but the licence allows personal, educational and non-commercial research use only — the restriction the final MIT release lifted. Artificial Analysis scores it 45; the card itself claims 44." },
  ...
  { name: "Fable 5.1", provider: "Anthropic", released: "2026/09", type: "Frontier", arch: "Undisclosed", params: "—", active: "—",
    attn: "Undisclosed", modality: "Text + image", context: 1000000, maxOut: 128000, license: "Proprietary", open: false, intel: 53, intelVersion: "4.3", codingAgent: 62, codingAgentVia: "Claude Code", codingAgentVersion: "1.5", agentic: null, vision: null, training: null,
    note: "Anthropic's current flagship, shipped 1 September 2026, and the top-rated model on Artificial Analysis's board at 53 under Index v4.3. Specifications match Fable 5 — 1M window, 128K maximum output, $10/$50 per MTok — with the knowledge cutoff moved to June 2026 and thinking now adaptive and always on, at a default effort of high, so it can no longer be switched off. Architecture, parameters and training are undisclosed, as everywhere else in the Claude line. It ships alongside Claude Mythos 5.1, which is not a second model: Anthropic's own documentation describes Mythos 5.1 as the same model as Fable 5.1, offered separately and by invitation only under Project Glasswing, for defensive cybersecurity work. The same held for Mythos 5, which shared Fable 5's specifications and pricing. That is why there is no Mythos row here — one set of weights under two names and two access routes is one model, and giving it a second row would double-count it in every figure on this page." },
  { name: "Fable 5", provider: "Anthropic", released: "2026/06", type: "Frontier", arch: "Undisclosed", params: "—", active: "—",
    attn: "Undisclosed", modality: "Text + image", context: 1000000, maxOut: 128000, license: "Proprietary", open: false, intel: 50, intelVersion: "4.3", codingAgent: 66, codingAgentVia: "Claude Code", codingAgentVersion: "1.3", agentic: 57, training: null,
    note: "Anthropic's flagship until Fable 5.1 replaced it in September 2026. Architecture undisclosed. Like all frontier closed models it is a decoder-only transformer at its core, but parameter counts, expert layout, and attention scheme are unpublished. Shares the long-context (1M) design goal of the Opus line with extra max-output headroom. This row previously called it \"Mythos-class\", which read as a tier above the Opus line; Anthropic's documentation is plainer than that — Claude Mythos 5 is this same model, sharing its specifications and pricing, offered by invitation only under Project Glasswing for defensive cybersecurity work." },
  { name: "Opus 4.8", provider: "Anthropic", released: "2026/05", type: "Frontier", arch: "Undisclosed", params: "—", active: "—",
    attn: "Undisclosed", modality: "Text + image", context: 1000000, maxOut: 64000, license: "Proprietary", open: false, intel: 57, intelVersion: "4.1", codingAgent: 61, codingAgentVia: "Claude Code", codingAgentVersion: "1.3", agentic: 49, training: null,
  ...
  { name: "Sonnet 4.6", provider: "Anthropic", released: "2026/02", type: "Frontier", arch: "Undisclosed", params: "—", active: "—",
    attn: "Undisclosed", modality: "Text + image", context: 1000000, maxOut: 64000, license: "Proprietary", open: false, intel: 48, intelVersion: "4.1", codingAgent: 38, codingAgentVia: "Claude Code", codingAgentVersion: "1.3", agentic: 42, training: null,
  ...
  { name: "Haiku 4.5", provider: "Anthropic", released: "2025/10", type: "Mid", arch: "Undisclosed", params: "—", active: "—",
    attn: "Undisclosed", modality: "Text + image", context: 200000, maxOut: 64000, license: "Proprietary", open: false, intel: 30, intelVersion: "4.1", codingAgent: null, codingAgentVia: null, agentic: 16, vision: 59, training: null,
  ...
  { name: "GPT-5.5", provider: "OpenAI", released: "2026/04", type: "Frontier", arch: "MoE (reported)", params: "—", active: "—",
    attn: "Undisclosed", modality: "Text + image + audio", context: 922000, maxOut: 128000, license: "Proprietary", open: false, intel: 56, intelVersion: "4.1", codingAgent: 61, codingAgentVia: "Codex", codingAgentVersion: "1.3", agentic: 47, training: null,
  ...
  { name: "gpt-oss-120b", provider: "OpenAI", released: "2025/08", type: "Mid", arch: "Sparse MoE", params: "117B", active: "5.1B",
    attn: "Sliding-window + global", modality: "Text", context: 131072, maxOut: null, license: "Apache 2.0", open: true, intel: 12, intelVersion: "4.3", codingAgent: null, codingAgentVia: null, agentic: null, vision: null,
    training: null,
    note: "OpenAI's open-weight release, and the only model in this table whose weights it has published: 117B total against 5.1B active, under Apache 2.0. It is sized around a deployment target rather than a parameter budget — the MoE weights are quantised to MXFP4 in post-training, which is what puts it on a single 80GB accelerator, and OpenAI states its own evaluations were run at that same quantisation rather than in full precision. The config alternates sliding-window and full-attention layers in strict 1:1 across 36 layers, with a 128-token window on the sliding half and 64 query heads to 8 KV. No training disclosure accompanied the release: no token budget, no data description, no stage list, so the pipeline column is empty rather than filled from the GPT-5 family it sits beside. Artificial Analysis rates it 12 under Index v4.3, at the bottom of the rated set, which is worth reading next to the licence rather than instead of it." },
  { name: "GPT-5 mini", provider: "OpenAI", released: "2025/08", type: "Mid", arch: "MoE (reported)", params: "—", active: "—",
    attn: "Undisclosed", modality: "Text + image", context: 400000, maxOut: 64000, license: "Proprietary", open: false, intel: 32, intelVersion: "4.1", codingAgent: null, codingAgentVia: null, agentic: 20, training: null,
  ...
  { name: "Gemini 3.1 Pro", provider: "Google", released: "2026/02", type: "Frontier", arch: "MoE (reported)", params: "—", active: "—",
    attn: "Sparse + long-context", modality: "Text + image + video + audio", context: 1000000, maxOut: 64000, license: "Proprietary", open: false, intel: 48, intelVersion: "4.1", codingAgent: 30, codingAgentVia: "Gemini CLI", codingAgentVersion: "1.3", agentic: 23, training: null,
  ...
  { name: "Gemini 3.8 Flash", provider: "Google", released: "2026/09", type: "Mid", arch: "MoE (reported)", params: "—", active: "—",
    attn: "Sparse + long-context", modality: "Text + image + video + audio", context: 1000000, maxOut: 64000, license: "Proprietary", open: false, intel: 41, intelVersion: "4.3", codingAgent: 42, codingAgentVia: "Antigravity SDK", codingAgentVersion: "1.5", agentic: null, vision: 86, training: null,
    trainingSource: "Google's model card states that Gemini 3.8 Flash is based on Gemini 3.7 Flash and refers to that card for the architecture, so the attention and expert layout recorded here are 3.7 Flash's rather than a fresh disclosure. No training budget is published for either.",
    note: "The September 2026 Flash release, and its model card is unusually candid about how little is new: architecture, model dependencies and the tier safety assessment all defer to the Gemini 3.7 Flash card. The published specifications are 3.7 Flash's too — 1M input window across text, image, audio and video, 64K text output — with the knowledge cutoff moved forward to March 2026. Pricing holds at $0.75 per million input tokens and $3.75 output on the discounted tier, double that at the regular rate. What Google does publish is the benchmark gap against its predecessor: DeepSWE v1.1 moves from 65.3% to 73.7%, which on its own card puts it above Claude Sonnet 5 and GPT-5.6 Terra on that evaluation while costing a fraction of either. Artificial Analysis rates it 41 on Index v4.3 and 42 on the Coding Agent Index v1.5 through Google's own Antigravity SDK." },
  { name: "Gemini 3.7 Flash", provider: "Google", released: "2026/08", type: "Mid", arch: "MoE (reported)", params: "—", active: "—",
    attn: "Sparse + long-context", modality: "Text + image + video + audio", context: 1000000, maxOut: 64000, license: "Proprietary", open: false, intel: 56, intelVersion: "4.1", codingAgent: 57, codingAgentVia: "Opencode", codingAgentVersion: "1.3", agentic: 45, vision: 86, training: null,
  ...
  { name: "Gemini 3.6 Flash", provider: "Google", released: "2026/07", type: "Mid", arch: "MoE (reported)", params: "—", active: "—",
    attn: "Sparse + long-context", modality: "Text + image + video + audio", context: 1000000, maxOut: 64000, license: "Proprietary", open: false, intel: 52, intelVersion: "4.1", codingAgent: 46, codingAgentVia: "Opencode", codingAgentVersion: "1.3", agentic: 41, training: null,
  ...
  { name: "Gemini 3.5 Flash", provider: "Google", released: "2026/05", type: "Mid", arch: "MoE (reported)", params: "—", active: "—",
    attn: "Sparse + long-context", modality: "Text + image + audio", context: 1000000, maxOut: 64000, license: "Proprietary", open: false, intel: 52, intelVersion: "4.1", codingAgent: null, codingAgentVia: null, agentic: 40, training: null,
  ...
  { name: "DeepSeek V4.1 Flash", provider: "DeepSeek", released: "2026/09", type: "Frontier", arch: "Sparse MoE", params: "552B", active: "16B",
    attn: "CSA2 (Compressed Sparse Attn 2)", modality: "Text + image", context: 1048576, maxOut: null, license: "MIT", open: true, intel: 40, intelVersion: "4.3", codingAgent: null, codingAgentVia: null, agentic: null, vision: 77,
    training: [
      { label: "Pre-training", tokens: "45T", detail: "Trained from scratch on a multimodal corpus of 45T tokens. Sparse attention is trained at a 64K sequence length and the window is extended to 1M at the 34T-token mark, so the long-context work sits inside this budget rather than in a stage of its own." },
      { label: "Post-training", tokens: null, detail: "SFT, then RL, then on-policy distillation, which DeepSeek states it ran without algorithmic modification — every substantive change is in the data pipeline, which synthesises agent tasks and environments at scale and grows data, tasks and rollouts together. Reasoning effort is exposed at inference as an integer from 1 to 100, so the cost/accuracy trade is set per request rather than by picking a variant." },
    ],
    note: "A bigger break than the point release in the name suggests. The stack is a causal encoder-decoder: 40 layers split into a 20-layer causal encoder and a 20-layer decoder, with the decoder's global KV projected from the encoder's final hidden states instead of from each decoder layer's own. That split is what lets it activate 8B parameters per token during prefill against 16B during decode — the active column records the decode figure, since that is what governs generation, and the prefill number is the one that matters for input-heavy agent work. Attention is CSA2, which gives every layer one of three static modes (Full, Reindex, Reuse) so main KV and indexer keys are shared across layers rather than recomputed, with a hierarchical indexer in the decoder confining later selection to a candidate pool built by the first Full-mode layer. With FP4 main-KV caching DeepSeek reports 890 bytes per token, about a quarter of V4 Flash. Two components sit outside the backbone: Engram, a 196B-parameter conditional memory reached by token lookup rather than by routing, and DSpark speculative decoding. That is why this row reads 552B — DeepSeek's own backbone figure — while the checkpoint on Hugging Face totals 763B once Engram and the vision encoder are counted. Vision is trained in from the start of language-model pre-training rather than attached to a finished text model." },
  { name: "DeepSeek V4 Pro", provider: "DeepSeek", released: "2026/04", type: "Frontier", arch: "Sparse MoE", params: "1.6T", active: "49B",
    attn: "Hybrid: CSA + HCA", modality: "Text + image + video + audio", context: 1048576, maxOut: 384000, license: "MIT", open: true, intel: 36, intelVersion: "4.3", codingAgent: 43, codingAgentVia: "Codex", codingAgentVersion: "1.5", agentic: 50, training: [{ label: "Pre-training", tokens: "32T+", detail: "Diverse, filtered high-quality tokens; Muon optimizer, mHC residual connections, anticipatory routing for MoE stability." }, { label: "Context extension", tokens: null, detail: "Two-stage long-context extension to the 1M window (token count not separately broken out)." }, { label: "Specialist SFT + RL", tokens: null, detail: "Independent domain experts (math, code, agent, instruction) each get SFT then GRPO with domain reward signals." }, { label: "On-policy distillation", tokens: null, detail: "A single student model distills from 10+ specialist teachers on its own rollouts (OPD), merging skills into one model." }],
    note: "61 layers, 384 routed experts + 1 shared, 6 active per token, so only 49B of 1.6T params fire per token. Hybrid attention interleaves Compressed Sparse Attention (4x KV compression + FP4 'lightning indexer' top-k selection) with Hierarchical Chunked Attention, plus manifold-constrained hyper-connections (mHC) replacing the standard residual stream. 384K max output is 3-6x its peers. DeepSeek published DeepSeek-V4-Pro-0813 on 13 August 2026 as the official release superseding the preview, adding a DSpark speculative-decoding module; every architecture field recorded here is unchanged in its config. The intelligence score is that release's, now read from AA's v4.3 index, while the coding and agentic scores still predate the re-base and sit on the older one." },
  { name: "DeepSeek V4 Flash", provider: "DeepSeek", released: "2026/04", type: "Mid", arch: "Sparse MoE", params: "284B", active: "13B",
    attn: "Hybrid: CSA + HCA", modality: "Text + image", context: 1048576, maxOut: 128000, license: "MIT", open: true, intel: 52, intelVersion: "4.1", codingAgent: 39, codingAgentVia: "Codex", codingAgentVersion: "1.5", agentic: 48, training: [{ label: "Pre-training", tokens: "32T+", detail: "DeepSeek reports a single '>32T tokens' figure covering both Pro and Flash; no separate Flash count is published." }, { label: "Context extension", tokens: null, detail: "Long-context extension to 1M; even lower FLOPs/KV than Pro." }, { label: "Specialist SFT + RL", tokens: null, detail: "Per-domain SFT + GRPO, same two-stage paradigm as Pro." }, { label: "On-policy distillation", tokens: null, detail: "Multi-teacher OPD into the unified student." }],
  ...
  { name: "MiniMax M3", provider: "MiniMax", released: "2026/06", type: "Frontier", arch: "Sparse MoE", params: "428B", active: "—",
    attn: "MSA sparse attention", modality: "Text + image + video", context: 1000000, maxOut: 64000, license: "Proprietary", open: false, intel: 30, intelVersion: "4.3", codingAgent: null, codingAgentVia: null, agentic: 36, vision: 79, training: null,
  ...
  { name: "Mistral Medium 3.5", provider: "Mistral", released: "2026/03", type: "Mid", arch: "Dense", params: "128B", active: "128B",
    attn: "Grouped-query attention", modality: "Text + image", context: 262144, maxOut: null, license: "Modified MIT", open: true, intel: 15, intelVersion: "4.3", codingAgent: null, codingAgentVia: null, agentic: null, vision: 65,
    training: null,
    note: "Mistral's first merged flagship in its own framing: one set of weights replacing both Mistral Medium 3.1 and Magistral in Le Chat, and Devstral 2 in its coding agent, with reasoning effort configurable per request so a single model covers a quick reply and a long agentic run. Dense rather than sparse, which is unusual at this size in 2026 — 88 layers at a 12,288 hidden size, 96 query heads to 8 KV. The 256K window is YaRN scaling at a factor of 64 over a 4,096-token trained base, not a natively trained context. The vision tower is Pixtral, trained from scratch for variable image sizes and aspect ratios. The licence is a modified MIT permitting commercial and non-commercial use with an exception for companies above a revenue threshold, so the weights are downloadable and modifiable but not unconditionally — the same shape of grant as Kimi K2.6's. Mistral published no training disclosure with the release: no token budget, no stage list, so that column stays empty. One caveat the repo raises itself: the Transformers config shipped with an error that degraded long-context behaviour until it was corrected, so the figures here are read from the fixed config." },
  { name: "Mistral Large 3", provider: "Mistral", released: "2025/12", type: "Frontier", arch: "Sparse MoE", params: "673B", active: "41B",
    attn: "MLA (Multi-head Latent Attn)", modality: "Text + image", context: 262144, maxOut: 64000, license: "Apache 2.0", open: true, intel: 16, intelVersion: "4.1", codingAgent: null, codingAgentVia: null, agentic: 6, training: null,
  ...
  { name: "GLM-5", provider: "Zhipu", released: "2026/02", type: "Frontier", arch: "Sparse MoE", params: "744B", active: "40B",
    attn: "MLA + DeepSeek Sparse Attn", modality: "Text + image", context: 202752, maxOut: 32000, license: "MIT", open: true, intel: 41, intelVersion: "4.1", codingAgent: null, codingAgentVia: null, agentic: null,
    training: [
  ...
  { name: "Command A", provider: "Cohere", released: "2025/03", type: "Mid", arch: "Dense", params: "111B", active: "111B",
    attn: "Grouped-query attention", modality: "Text", context: 256000, maxOut: 32000, license: "CC-BY-NC", open: true, intel: 7, intelVersion: "4.1", codingAgent: null, codingAgentVia: null, agentic: null,
    training: [
  ...
  { name: "Muse Glimmer", provider: "Meta", released: "2026/08", type: "SLM", arch: "Dense", params: "30B", active: "30B",
    attn: "Sliding-window + global", modality: "Text + image", context: 131072, maxOut: null, license: "Apache 2.0", open: true, intel: 18, intelVersion: "4.3", codingAgent: null, codingAgentVia: null, agentic: 23, vision: 74, training: null,
  ...
  { name: "Gemma 4 E4B", provider: "Google", released: "2026/04", type: "SLM", arch: "Dense", params: "8B (4.5B eff.)", active: "8B (4.5B eff.)",
    attn: "Sliding-window + global", modality: "Text + image + video + audio", context: 128000, maxOut: 8192, license: "Apache 2.0", open: true, intel: 12, intelVersion: "4.1", codingAgent: null, codingAgentVia: null, agentic: null, training: [{ label: "Pre-training", tokens: null, detail: "Distillation-based pretraining at edge scale (token budget not separately published)." }, { label: "Post-training", tokens: null, detail: "Instruction tuning + RLHF; adds audio input." }],
  ...
  { name: "Gemma 3 4B", provider: "Google", released: "2025/03", type: "SLM", arch: "Dense", params: "4B", active: "4B",
    attn: "Sliding-window + global", modality: "Text + image", context: 128000, maxOut: 8192, license: "Gemma", open: true, intel: 1, intelVersion: "4.1", codingAgent: null, codingAgentVia: null, agentic: null, training: [{ label: "Pre-training", tokens: "4T", detail: "Knowledge-distillation pretraining (Gemma 3 report: 4T tokens for the 4B model)." }, { label: "Post-training", tokens: null, detail: "Distillation, SFT, and RLHF." }],
  ...
  { name: "Needle 2", provider: "Cactus Compute", released: "2026/07", type: "SLM", arch: "Dense", params: "45M", active: "45M",
    attn: "Grouped-query attention", modality: "Text", context: 2048, maxOut: null, license: "Apache 2.0", open: true, intel: null, codingAgent: null, codingAgentVia: null, agentic: null, vision: null, training: null,
    note: "Not a general language model, and the config says so: the architecture class is NeedleForToolCalling and the model is built for tool calls, device control and structured extraction rather than knowledge. That is the point of it \u2014 45M parameters, a 2,048-token window and an 8,192-token vocabulary, shipped as a single 14MB binary that runs a session in 28MB of RAM with no runtime and no downloads. Weights are quantised to about 2.2 effective bits by the lab's own scheme, so the 45M figure and the file size are not related the way they would be for a bf16 model. Cactus reports 500 tokens/sec on a Raspberry Pi 5 and enough headroom to run on an ESP32 microcontroller, and benchmarks it against FunctionGemma 270M and LFM2.5 230M at five to seventy times smaller. Attention is grouped-query with a 256-token sliding window on a 2,048 window \u2014 recorded in the spec panel rather than the column, since the window is the deployment constraint rather than the mechanism." },
  ...
  { name: "Qwen3.5 (0.8B)", provider: "Alibaba", released: "2026/02", type: "SLM", arch: "Dense", params: "0.8B", active: "0.8B",
    attn: "Gated DeltaNet + gated attn", modality: "Text + image + video", context: 262144, maxOut: 8192, license: "Apache 2.0", open: true, intel: 5, intelVersion: "4.1", codingAgent: null, codingAgentVia: null, agentic: null, training: [{ label: "Pre-training", tokens: null, detail: "Alibaba published no Qwen3.5 technical report. The only official source is the Qwen3.5 blog (\"Towards Native Multimodal Agents\", Feb 2026), which names the training stages but discloses no token budget for any of them — so no figure is shown here rather than borrowing the previous generation's." }, { label: "Post-training", tokens: null, detail: "SFT + RL; thinking/non-thinking modes." }],
  ...
  { name: "Llama 3.2 1B", provider: "Meta", released: "2024/09", type: "SLM", arch: "Dense", params: "1B", active: "1B",
    attn: "Grouped-query attention", modality: "Text", context: 128000, maxOut: 8192, license: "Llama 3.2 Community", open: true, intel: 1, intelVersion: "4.1", codingAgent: null, codingAgentVia: null, agentic: null, training: [{ label: "Pre-training", tokens: "Up to 9T", detail: "Pruned + distilled from Llama 3.1 8B/larger teachers." }, { label: "Post-training", tokens: null, detail: "SFT + DPO alignment." }],
  ...
  { name: "Mistral Small 4", provider: "Mistral", released: "2026/03", type: "SLM", arch: "Sparse MoE", params: "119B", active: "6.63B",
    attn: "MLA (Multi-head Latent Attn)", modality: "Text + image", context: 256000, maxOut: 16000, license: "Apache 2.0", open: true, intel: 20, intelVersion: "4.1", codingAgent: null, codingAgentVia: null, agentic: 5, training: null,
  ...
  { name: "Tiny Aya", provider: "Cohere", released: "2026/02", type: "SLM", arch: "Dense", params: "3.35B", active: "3.35B",
    attn: "Sliding-window + global", modality: "Text", context: 8192, maxOut: 4096, license: "CC-BY-NC", open: true, intel: 1, intelVersion: "4.1", codingAgent: null, codingAgentVia: null, agentic: null, training: null,
  ...
  { name: "Qwen3 235B-A22B", provider: "Alibaba", released: "2025/04", type: "Frontier", arch: "Sparse MoE", params: "235B", active: "22B",
    attn: "Grouped-query attention", modality: "Text", context: 131072, maxOut: null, license: "Apache 2.0", open: true, intel: 13, intelVersion: "4.1", codingAgent: null, codingAgentVia: null, agentic: null,
    training: [
  ...
  { name: "Qwen3-VL 235B-A22B", provider: "Alibaba", released: "2025/09", type: "Frontier", arch: "Sparse MoE", params: "235B", active: "22B",
    attn: "Grouped-query attention", modality: "Text + image + video", context: 262144, maxOut: null, license: "Apache 2.0", open: true, intel: 21, intelVersion: "4.1", codingAgent: null, codingAgentVia: null, agentic: null,
    training: [
...
export const SPECS = {
  "DeepSeek V4.1 Flash": { vocab: "129,280", layers: 40, hidden: "5,120", heads: "64 Q / 1 KV (GQA 64:1)", experts: "384 routed · 6 active · 1 shared", layerMix: "20-layer causal encoder + 20-layer decoder; CSA2 assigns each layer Full, Reindex or Reuse mode", window: "128", posEmb: "RoPE θ=10K + yarn ×16 over a 65,536 base; 64 RoPE dims per head", ffn: "2,304 per expert", activation: "silu", norm: "RMSNorm (ε=1e-20)", headDim: 512, source: "config.json (text_config)" },
  "K2 Horizon 375B-A23B": { vocab: "250,624", layers: 61, hidden: "6,144", heads: "48 Q / 8 KV (GQA 6:1)", experts: "192 routed · 8 active · 1 shared", layerMix: "First 3 layers dense, 58 MoE; no sliding window", window: "—", posEmb: "RoPE θ=10M, 64 of 128 head dims rotated", ffn: "16,384 dense · 1,792 per expert", activation: "silu", norm: "RMSNorm (ε=1e-6)", headDim: 128, source: "config.json" },
  "gpt-oss-120b": { vocab: "201,088", layers: 36, hidden: "2,880", heads: "64 Q / 8 KV (GQA 8:1)", experts: "128 routed · 4 active", layerMix: "18 sliding-window : 18 full attention, strictly alternating", window: "128", posEmb: "RoPE θ=150K + yarn ×32 over a 4,096 base", ffn: "2,880 per expert", activation: "silu (SwiGLU clamped at 7.0)", norm: "RMSNorm (ε=1e-5)", headDim: 64, source: "config.json" },
  "Mistral Medium 3.5": { vocab: "131,072", layers: 88, hidden: "12,288", heads: "96 Q / 8 KV (GQA 12:1)", experts: "— (dense)", window: "—", posEmb: "RoPE θ=1M + yarn ×64 over a 4,096 base", ffn: "28,672", activation: "silu", norm: "RMSNorm (ε=1e-5)", headDim: 128, source: "config.json (text_config)" },
  ...
  "GLM-5.3": { vocab: "154,880", layers: 78, hidden: "6,144", heads: "64 Q / 64 KV; DSA indexer 32 heads, top-k 2,048", experts: "256 routed \u00b7 8 active \u00b7 1 shared", layerMix: "DeepSeek Sparse Attention throughout; first 3 layers dense FFN", window: "\u2014", posEmb: "RoPE on 64 of 256 head dims; MLA latent 512, query latent 2,048", ffn: "12,288 dense \u00b7 2,048 per expert", activation: "silu", norm: "RMSNorm (\u03b5=1e-5)", headDim: 192, source: "config.json" },
  "Hy4 preview": { vocab: "120,832", layers: 78, hidden: "6,144", heads: "64 Q / 8 KV; DSA indexer 32 heads, top-k 2,048", experts: "256 routed \u00b7 8 active \u00b7 1 shared", layerMix: "Gated DSA on all 78 layers; layer 1 dense FFN, 77 MoE; 4 residual streams (iHC)", window: "\u2014", posEmb: "RoPE on 64 of 256 head dims; MLA latent 512, query latent 2,048", ffn: "18,432 dense \u00b7 2,048 per expert", activation: "silu", norm: "RMSNorm (\u03b5=1e-5)", headDim: 64, source: "config.json" },
  "Ornith 1.5 397B": { vocab: "248,320", layers: 60, hidden: "4,096", heads: "32 Q / 2 KV", experts: "512 routed \u00b7 10 active", layerMix: "3 Gated DeltaNet : 1 full attention (45:15)", window: "\u2014", posEmb: "Partial RoPE (factor 0.25); YaRN \u00d74 offered at serve time for 1M", ffn: "1,024 per expert", activation: "silu", norm: "RMSNorm (\u03b5=1e-6)", headDim: 256, source: "config.json (Qwen3.5-derived)" },
  "Ling 3.0 flash": { vocab: "157,184", layers: 42, hidden: "2,560", heads: "32 Q / 32 KV", experts: "512 routed \u00b7 8 active", layerMix: "5 KDA : 1 MLA, native from the first pre-training step; first 2 layers dense", window: "\u2014", posEmb: "RoPE \u03b8=6M, partial (half the head dims rotated); MLA latent 512", ffn: "6,144 dense \u00b7 768 per expert", activation: "silu", norm: "RMSNorm (\u03b5=1e-6)", headDim: 128, source: "config.json" },
  "dots3-note preview": { vocab: "152,064", layers: 46, hidden: "5,120", heads: "128 Q / 128 KV", experts: "256 routed \u00b7 8 active \u00b7 1 shared", layerMix: "33 sliding-window : 13 global; first layer dense", window: "sliding on 33 of 46 layers", posEmb: "RoPE \u03b8=80M; MLA latent 512, query latent 1,024", ffn: "13,824 dense \u00b7 1,536 per expert", activation: "silu", norm: "RMSNorm (\u03b5=1e-5)", headDim: 128, source: "config.json" },
  "Needle 2": { vocab: "8,192", layers: 27, hidden: "512", heads: "8 Q / 4 KV", experts: "\u2014 (dense)", layerMix: "Uniform sliding-window attention", window: "256", posEmb: "RoPE \u03b8=100K", ffn: "Hadamard MLP", activation: "\u2014", norm: "\u2014", headDim: 64, source: "config.json" },
  "GLM-5.3-Flash": { vocab: "154,880", layers: 45, hidden: "4,096", heads: "64 Q / 64 KV; DSA indexer 32 heads, top-k 2,048", experts: "288 routed \u00b7 8 active \u00b7 1 shared", layerMix: "3 linear (KDA) : 1 DeepSeek Sparse Attention, repeated; first 3 layers dense", window: "\u2014", posEmb: "None on the attention layers: qk_rope_head_dim is 0, so all 256 head dims are unrotated; MLA latent 512, query latent 1,536", ffn: "12,288 dense \u00b7 2,048 per expert", activation: "silu", norm: "RMSNorm (\u03b5=1e-5)", headDim: "256 (v 256)", source: "config.json" },
  "Qwen3.8-Flash-Next": { vocab: "248,320", layers: 48, hidden: "2,560", heads: "24 Q / 2 KV softmax; 16 QK / 48 V linear; QSA indexer MQA 4 Q + 1 shared K", experts: "512 routed \u00b7 10 active \u00b7 1 shared", layerMix: "3 Gated DeltaNet : 1 Qwen Sparse Attention, repeated 12 times over 48 layers", window: "QSA budget 512 blocks / 2,048 tokens", posEmb: "Partial RoPE (factor 0.25; 64 of 256 head dims rotated)", ffn: "640 per expert", activation: "silu", norm: "RMSNorm (\u03b5=1e-6)", headDim: 256, source: "config.json" },
  ...
  "Motif 3": { vocab: "220,160", layers: 53, hidden: "4,096", heads: "80 Q (64 signal / 16 noise) / 16 KV", experts: "384 routed · 8 active · 1 shared", layerMix: "1 full attention : 3 sliding-window, interleaved (period 4); first 2 layers dense", window: "128", posEmb: "RoPE θ=10K; MLA head split 64 RoPE / 128 NoPE dims; a yarn ×64 block is declared but apply_yarn_scaling is false", ffn: "12,288 dense · 1,280 per expert", activation: "poly_norm", norm: "RMSNorm (ε=1e-5)", headDim: 192, source: "config.json" },
  "Motif 3 Beta": { vocab: "220,160", layers: 53, hidden: "4,096", heads: "80 Q (64 signal / 16 noise) / 16 KV", experts: "384 routed · 8 active · 1 shared", layerMix: "1 full attention : 3 sliding-window, interleaved (period 4); first 2 layers dense", window: "128", posEmb: "RoPE θ=10K; MLA head split 64 RoPE / 128 NoPE dims; a yarn ×64 block is declared but apply_yarn_scaling is false", ffn: "12,288 dense · 1,280 per expert", activation: "poly_norm", norm: "RMSNorm (ε=1e-5)", headDim: 192, source: "config.json" },
...
export const HF_LINKS = {
  ...
  "K2 Horizon 375B-A23B": "IFM/K2-Horizon-375B-A23B",
  ...
  "Ornith 1.5 397B": "ornith-ai/Ornith-1.5-397B",
  ...
  "Motif 3 Beta": "Motif-Technologies/Motif-3-Beta",
...
export const DIAGRAMS = {
  ...
  "Muse Glimmer": { slug: "muse-glimmer-30b", title: "Muse Glimmer 30B" },
  ...
  "Motif 3 Beta": { slug: "motif-3-beta", title: "Motif 3 Beta" },
  ...
  "Qwen3.8 (27B)": { slug: "qwen3-8-27b", title: "Qwen3.8 27B" },
...
export const REPORTS = {
  ...
  "DeepSeek V4.1 Flash": { label: "DeepSeek-V4.1 technical report (PDF)", url: "https://huggingface.co/deepseek-ai/DeepSeek-V4.1-Flash/blob/main/DeepSeek_V41_Tech_Report.pdf" },
  // IFM's launch blog at ifm.ai/blog/k2/ answered 403 and could not be verified, so
  // the model card — which carries the full stage-by-stage training table anyway —
  // is cited in its place rather than an unchecked link.
  "K2 Horizon 375B-A23B": { label: "K2-Horizon-375B-A23B model card", url: "https://huggingface.co/IFM/K2-Horizon-375B-A23B" },
  // Resolved against the arXiv API on 19 September 2026: the id returns "gpt-oss-120b
  // & gpt-oss-20b Model Card", which is what the label says. It was cited to the
  // Hugging Face card for a week because arXiv was rate-limiting and an unverified id
  // is worse than none.
  "gpt-oss-120b": { label: "gpt-oss-120b & gpt-oss-20b model card (arXiv 2508.10925)", url: "https://arxiv.org/abs/2508.10925" },
  "Mistral Medium 3.5": { label: "Mistral Medium 3.5 announcement", url: "https://mistral.ai/news/vibe-remote-agents-mistral-medium-3-5" },
  ...
  "Hy4 preview": { label: "Hy4 preview model card", url: "https://huggingface.co/tencent/Hy4-preview" },
  "Ornith 1.5 397B": { label: "Ornith-1.5-397B model card", url: "https://huggingface.co/ornith-ai/Ornith-1.5-397B" },
  "Ling 3.0 flash": { label: "Ling-3.0-flash model card", url: "https://huggingface.co/inclusionAI/Ling-3.0-flash" },
  "dots3-note preview": { label: "dots3-note preview model card", url: "https://huggingface.co/dots-studio/dots3-note-prev" },
  "Needle 2": { label: "Needle: a small model for tool calling (arXiv 2607.18363)", url: "https://arxiv.org/abs/2607.18363" },
  "GLM-5.3-Flash": { label: "GLM-5.3-Flash model overview (Z.ai docs)", url: "https://docs.z.ai/guides/llm/glm-5.3-flash" },
  "Qwen3.8-Flash-Next": { label: "Qwen3.8-Flash-Next technical report", url: "https://github.com/QwenLM/Qwen3.8-Flash-Next/blob/main/tech_report.pdf" },
  "GLM-5.3": { label: "GLM-5.3 model overview (Z.ai docs)", url: "https://docs.z.ai/guides/llm/glm-5.3" },
  ...
  "Motif 3": { label: "Motif 3: Technical Report", url: "https://arxiv.org/abs/2608.09119" },
  "Motif 3 Beta": { label: "Motif-3-Beta model card", url: "https://huggingface.co/Motif-Technologies/Motif-3-Beta" },
  ...
  "Fable 5.1": { label: "Introducing Claude Fable 5.1 and Claude Mythos 5.1", url: "https://www.anthropic.com/claude-fable-and-mythos-5-1" },
  "GPT-6 Astra": { label: "GPT-6 Astra model page (OpenAI API docs)", url: "https://platform.openai.com/docs/models/gpt-6-astra" },
  ...
  "Gemini 3.5 Flash-Lite": { label: "Gemini 3.5 Flash-Lite model card", url: "https://deepmind.google/models/model-cards/gemini-3-5-flash-lite/" },
  ...
  "Gemini 3.8 Flash": { label: "Gemini 3.8 Flash model card", url: "https://deepmind.google/models/model-cards/gemini-3-8-flash/" },
...
export const ATTENTION_INFO = {
  "Gated DSA + IndexCache": {
    desc: "DeepSeek Sparse Attention with a gate, on every layer rather than some of them: a 32-head indexer picks 2,048 blocks per query and the rest of the sequence is never read. Tencent's addition is IndexCache, which reuses one layer's sparse index in the layers above instead of recomputing the selection at each one \u2014 the selection, not the attention, being the part that was repeated.",
    paper: { label: "IndexCache \u2014 cross-layer index reuse (arXiv 2603.12201)", url: "https://arxiv.org/abs/2603.12201" },
  },
  "KDA + MLA (5:1 layers)": {
    desc: "Five Kimi Delta Attention layers, each carrying a constant-size recurrent state, to every one Multi-head Latent Attention layer that keeps a real KV cache compressed into a low-rank latent. Ant Group's claim for Ling 3.0 is that the ratio is native \u2014 present from the first pre-training step rather than reached by converting a trained softmax model afterwards, which is how most hybrids of this shape are built.",
    paper: { label: "Gated DeltaNet \u2014 KDA's lineage (arXiv 2412.06464)", url: "https://arxiv.org/abs/2412.06464" },
  },
  "KDA + DSA (34:11 layers)": {
    desc: "Two economies stacked rather than one: 34 of GLM-5.3-Flash's 45 layers are Kimi-style linear delta attention with a fixed recurrent state, and the other 11 are DeepSeek Sparse Attention, which keeps a full cache but reads only the top 2,048 blocks its indexer selects. Neither layer type pays the quadratic cost, so the exact layers are cheap enough to place every fourth.",
    paper: { label: "Native Sparse Attention \u2014 DSA's lineage (arXiv 2502.11089)", url: "https://arxiv.org/abs/2502.11089" },
  },
  "Gated DeltaNet + QSA (36:12 layers)": {
    desc: "Qwen's hybrid with the softmax half replaced. Three Gated DeltaNet layers still carry a constant-size state, but the fourth is Qwen Sparse Attention, which scores micro-blocks rather than individual tokens and reads a budget of 512 blocks or 2,048 tokens. Selecting blocks rather than tokens is what cuts the long-context latency; the cost is that relevance is judged a block at a time.",
  ...
  "GDLA (Grouped Differential Latent Attn)": {
    desc: "Motif's own scheme, folding grouped differential attention into MLA's compressed key/value latent. The differential half splits the query heads unevenly — Motif 3 runs 64 signal heads against 16 noise heads — and subtracts the noise path's attention from the signal path's to cancel what neither agreed was relevant, scaled per token by a learned sigmoid coefficient. The grouping is what makes that affordable: signal heads are repeated against the noise heads at a ratio of 4, so the noise estimate costs a quarter of the capacity rather than half, as symmetric differential attention would. Both paths then read one shared low-rank KV latent instead of keeping separate caches, with position carried on a decoupled rotary slice of each head.",
    paper: { label: "Grouped Differential Attention — GDLA's lineage (arXiv 2510.06949)", url: "https://arxiv.org/abs/2510.06949" },
  },
  ...
  "CSA2 (Compressed Sparse Attn 2)": {
    desc: "DeepSeek V4.1's successor to CSA, and the change is what gets shared rather than what gets skipped. Every layer is assigned one of three static modes — Full, Reindex or Reuse — so that main KV and indexer keys are projected once and read by the layers above instead of being recomputed at each one. In the decoder a hierarchical indexer restricts later selection to a candidate pool built by the first Full-mode layer, which bounds indexing cost independently of how long the context is. With the main KV cached in FP4, DeepSeek reports 890 bytes per token.",
    paper: { label: "Native Sparse Attention (arXiv 2502.11089)", url: "https://arxiv.org/abs/2502.11089" },
  },
  "Hybrid linear + full": {
 ...
 *
 * `basis` names the index version a figure was measured under, and it is printed
 * for the same reason `via` is. Artificial Analysis re-based the Intelligence Index
 * at v4.2 and again at v4.3, adding evaluations rather than re-testing models, which
 * moved every score down 12-18 points. It has re-rated only some of the models here,
 * so this column necessarily holds figures from two scales at once. A reader who
 * sees 51 beside 57 has to see that the 57 was measured on a scale AA has since
 * replaced, or the column silently claims the older model is the stronger one.
 */
function ScoreCell({ value, via, lead, basis, unit = "" }) {
  return (
    <td style={{ ...S.td }}>
      {value == null ? (
        ...
        <>
          ...
          {basis && <>{" "}<span style={S.viaTag}>v{basis} scoring</span></>}
        </>
      )}
    </td>
  );
 ...
 *
 * Intelligence is restricted to rows measured on the current index version, because
 * a lead across two versions is not a lead at all. AA's v4.3 re-based the index
 * downward, so the largest number in the column belongs to a model rated under the
 * superseded v4.1 — marking it would crown whichever model happened not to be
 * re-tested. Comparing only within the live basis is the one honest reading, and
 * the tooltip says so.
 */
/**
 * The AA index versions this table treats as live, per column.
 *
 * Two of the four AA columns are versioned indexes that AA re-bases by changing
 * which evaluations go into them, and it re-rates only some models when it does.
 * So both columns hold figures from two scales at once, and every place that
 * compares one score to another — the lead marker, the sort — has to know which
 * scale a figure is on. A column absent from this map is not versioned: MMMU-Pro
 * is a single benchmark, and the Agentic Index is one AA has withdrawn, so its
 * figures are frozen on one basis rather than split across two.
 */
const CURRENT_INDEX = { intel: "4.3", codingAgent: "1.5" };
const VERSION_FIELD = { intel: "intelVersion", codingAgent: "codingAgentVersion" };
/** The index version a figure was measured under, or null for unversioned columns. */
const basisOf = (m, key) => (VERSION_FIELD[key] ? m[VERSION_FIELD[key]] ?? null : null);
/** Whether a figure sits on the version the column currently treats as live. */
const onLiveBasis = (m, key) => !CURRENT_INDEX[key] || basisOf(m, key) === CURRENT_INDEX[key];

const LEADERS = Object.fromEntries(["intel", "codingAgent", "agentic", "vision"].map((k) =>
  [k, Math.max(...MODELS
    .filter((m) => onLiveBasis(m, k))
    .map((m) => (m[k] == null ? -1 : m[k])))]));

const COLUMNS = [
  { key: "name", label: "Model", numeric: false },
  { key: "intel", label: "Intelligence", numeric: true, sub: "Artificial Analysis",
    tip: { lead: "Artificial Analysis Intelligence Index v4.3 — ten evaluations combined into one 0-100 score.",
      points: [
        ...
        "Leaderboard snapshot 13 September 2026, taken at v4.3",
  ...
  { key: "codingAgent", label: "Coding agent", numeric: true, sub: "AA · best harness",
    tip: { lead: "Artificial Analysis Coding Agent Index v1.5 — three benchmarks, equally weighted.",
      points: [
        "DeepSWE v1.1 · Terminal-Bench v4 · SWE-Atlas-QnA",
        "Scores an agent driving a model, not the model — the harness is named under each figure",
        "GLM-5.3 is 54 through Opencode; the same model scores differently elsewhere",
        "Where AA publishes several pairings, the highest is shown",
        "Replaced the Coding Index, which AA has withdrawn from its site",
        "AA re-based this index from v1.3 to v1.5 by swapping Terminal-Bench v2 for v4 and DeepSWE for v1.1, which moved every re-rated pairing down 7-16 points",
        "It has re-rated only some of the models here, so a figure marked “v1.3 scoring” is on the superseded scale and is not comparable to an unmarked one",
        "The lead marker and the sort both compare only within v1.5",
  ...
  { key: "agentic", label: "Agentic", numeric: true, sub: "Artificial Analysis",
    tip: { lead: "Artificial Analysis Agentic Index — two evaluations of long-horizon, tool-using work, equally weighted.",
      points: [
        ...
        "AA no longer publishes this composite — as of the v4.3 re-base its page carries the underlying evaluations only, and GDPval-AA v2 now counts toward Intelligence directly. These figures are the last published ones and no longer reconcile against a live source",
...
export default function FrontierModelsTable({ focus } = {}) {
  ...
  const rows = useMemo(() => {
    ...
    r = [...r].sort((a, b) => {
      ...
      // The two versioned columns sort on two keys, index version before score,
      // because each holds two scales and a single numeric sort silently ranks
      // across them. Sorted on the number alone the table opened on Qwen3.8 Max at
      // 58 — top of the atlas only because AA had not re-tested it — while Opus 5
      // at 51 on the current index sat six rows down. That is the same cross-scale
      // comparison the lead marker refuses to make, and the default view is where
      // it misleads most, since it is the order nobody chose. Coding agent went the
      // same way a week later, when AA re-based it from v1.3 to v1.5.
      else if (sortKey === "intel" || sortKey === "codingAgent") {
        const rank = (m) => (m[sortKey] == null ? -1 : onLiveBasis(m, sortKey) ? 1 : 0);
        const ar = rank(a), br = rank(b);
        if (ar !== br) return sortDir === "asc" ? ar - br : br - ar;
        av = a[sortKey] == null ? -1 : a[sortKey];
        bv = b[sortKey] == null ? -1 : b[sortKey];
      }
      else if (sortKey === "agentic" || sortKey === "vision") {
        av = a[sortKey] == null ? -1 : a[sortKey];
        bv = b[sortKey] == null ? -1 : b[sortKey];
      }
    ...
    <div style={S.page}>
      <div style={S.shell}>
                ...
                return (
                  <React.Fragment key={m.name}>
                    <tr onClick={() => setExpanded(isOpen ? null : m.name)}
                      ...
                      {/* The basis has to gate the lead as well as label the cell: a
                          superseded score can equal the live leader numerically
                          without being level with it. */}
                      <ScoreCell value={m.intel}
                        basis={onLiveBasis(m, "intel") ? null : basisOf(m, "intel")}
                        lead={onLiveBasis(m, "intel") && m.intel === LEADERS.intel} />
                      <ScoreCell value={m.codingAgent} via={m.codingAgentVia}
                        basis={onLiveBasis(m, "codingAgent") ? null : basisOf(m, "codingAgent")}
                        lead={onLiveBasis(m, "codingAgent") && m.codingAgent === LEADERS.codingAgent} />
        ...
        <footer style={{ ...S.footer, paddingBottom: selected.length > 0 ? 96 : undefined }}>
          <span>Intelligence — the Artificial Analysis Intelligence Index v4.3, a composite of ten evaluations. Where AA lists a model at several reasoning efforts, the highest-scoring one is shown. AA re-based the index by adding harder evaluations rather than re-testing, which moved every score down 12-18 points, and it has re-rated only some of the models here: a figure marked “v4.1 scoring” was measured on the superseded scale and cannot be compared to an unmarked one.</span>
          <span>Coding agent — the Artificial Analysis Coding Agent Index v1.5, which scores a coding agent driving a model rather than the model on its own. The harness is named under every figure, because the same model scores very differently through a different one. As with Intelligence, AA re-based this index and re-rated only some pairings, so a figure marked “v1.3 scoring” was measured on the superseded scale and cannot be compared to an unmarked one.</span>
          <span>Agentic — the Artificial Analysis Agentic Index, the average of GDPval-AA v2 and 𝜏³-Banking. Both also count toward Intelligence, so it is that score re-cut for long-horizon tool use, not a second opinion. AA withdrew this composite at the v4.3 re-base and now publishes the underlying evaluations only, so these are the last figures it reported rather than current ones.</span>
...
export const S = {
  ...
  segOn: { background: "var(--accent-fill)", color: "var(--on-clay)" },
  ...
  compareGo: { background: "var(--accent-fill)", color: "var(--on-clay)", border: "none", borderRadius: 0,
  ...
  stageNum: { fontFamily: mono, fontSize: 11, fontWeight: 700, color: "var(--on-clay)", background: "var(--accent-fill)",
