...
export const MODELS = [
  ...
  { name: "Opus 5", provider: "Anthropic", released: "2026/07", type: "Frontier", arch: "Undisclosed", params: "\u2014", active: "\u2014",
    attn: "Undisclosed", modality: "Text + image", context: 1000000, maxOut: 128000, license: "Proprietary", open: false, intel: 51, codingAgent: 67, codingAgentVia: "Claude Code", agentic: 59, vision: 85, training: null,
  ...
  { name: "GPT-5.6 Sol", provider: "OpenAI", released: "2026/07", type: "Frontier", arch: "MoE (reported)", params: "\u2014", active: "\u2014",
    attn: "Undisclosed", modality: "Text + image + audio", context: 1000000, maxOut: 128000, license: "Proprietary", open: false, intel: 47, codingAgent: 67, codingAgentVia: "Codex", agentic: 58, vision: 83, training: null,
  ...
  { name: "GPT-5.6 Terra", provider: "OpenAI", released: "2026/07", type: "Frontier", arch: "MoE (reported)", params: "\u2014", active: "\u2014",
    attn: "Undisclosed", modality: "Text + image", context: 1000000, maxOut: 128000, license: "Proprietary", open: false, intel: 42, codingAgent: 62, codingAgentVia: "Codex", agentic: 50, vision: 81, training: null,
    note: "Middle tier of the GPT-5.6 family \u2014 OpenAI's intended production default. Reported to land just above Claude Fable 5 on the Artificial Analysis Coding Agent Index while sitting below Sol. Artificial Analysis has since rated it 42 on intelligence, from the max-effort row." },
  { name: "GPT-5.6 Luna", provider: "OpenAI", released: "2026/07", type: "Mid", arch: "MoE (reported)", params: "\u2014", active: "\u2014",
    attn: "Undisclosed", modality: "Text + image", context: 1000000, maxOut: 128000, license: "Proprietary", open: false, intel: 38, codingAgent: 59, codingAgentVia: "Codex", agentic: 47, vision: 79, training: null,
  ...
  { name: "Grok 4.6", provider: "xAI", released: "2026/08", type: "Frontier", arch: "Undisclosed", params: "\u2014", active: "\u2014",
    attn: "Undisclosed", modality: "Text + image", context: 500000, maxOut: null, license: "Proprietary", open: false, intel: 44, codingAgent: null, codingAgentVia: null, agentic: 59, training: null,
  ...
  { name: "Kimi K3", provider: "Moonshot", released: "2026/07", type: "Frontier", arch: "Sparse MoE", params: "2.8T", active: "104.2B",
    attn: "KDA + full attn (69:24 layers)", modality: "Text + image + video", context: 1048576, maxOut: 131072, license: "Kimi K3 License", open: true, intel: 44, codingAgent: 61, codingAgentVia: "Kimi Code CLI", agentic: 54, vision: 81,
    training: [
  ...
  { name: "GLM-5.3-Flash", provider: "Zhipu", released: "2026/08", type: "Frontier", arch: "Sparse MoE", params: "320B", active: "18B",
    attn: "KDA + DSA (34:11 layers)", modality: "Text + image", context: 1000000, maxOut: 128000, license: "MIT", open: true, intel: 42, codingAgent: null, codingAgentVia: null, agentic: 58, vision: null,
    training: [
  ...
  { name: "GLM-5.3", provider: "Zhipu", released: "2026/08", type: "Frontier", arch: "Sparse MoE", params: "743B", active: "40B",
    attn: "DSA + MLA (IndexShare)", modality: "Text", context: 1000000, maxOut: 128000, license: "GLM-5.3 License", open: true, intel: 45, codingAgent: null, codingAgentVia: null, agentic: 59, training: null,
  ...
  { name: "Inkling", provider: "Thinking Machines", released: "2026/07", type: "Frontier", arch: "Sparse MoE", params: "975B", active: "41B",
    attn: "Undisclosed", modality: "Text + image + audio", context: 1000000, maxOut: null, license: "Apache 2.0", open: true, intel: 26, codingAgent: null, codingAgentVia: null, agentic: 34, vision: 74, training: null,
  ...
  { name: "Motif 3 Beta", provider: "Motif Technologies", released: "2026/07", type: "Frontier", arch: "Sparse MoE", params: "~314B", active: "~13B",
    attn: "GDLA (Grouped Differential Latent Attn)", modality: "Text", context: 262144, maxOut: null, license: "Motif non-commercial", open: true, intel: 45, codingAgent: null, codingAgentVia: null, agentic: null, training: null,
  ...
  { name: "Fable 5", provider: "Anthropic", released: "2026/06", type: "Frontier", arch: "Undisclosed", params: "—", active: "—",
    attn: "Undisclosed", modality: "Text + image", context: 1000000, maxOut: 128000, license: "Proprietary", open: false, intel: 50, codingAgent: 66, codingAgentVia: "Claude Code", agentic: 57, training: null,
  ...
  { name: "MiniMax M3", provider: "MiniMax", released: "2026/06", type: "Frontier", arch: "Sparse MoE", params: "428B", active: "—",
    attn: "MSA sparse attention", modality: "Text + image + video", context: 1000000, maxOut: 64000, license: "Proprietary", open: false, intel: 30, codingAgent: null, codingAgentVia: null, agentic: 36, vision: 79, training: null,
  ...
  { name: "Muse Glimmer", provider: "Meta", released: "2026/08", type: "SLM", arch: "Dense", params: "30B", active: "30B",
    attn: "Sliding-window + global", modality: "Text + image", context: 131072, maxOut: null, license: "Apache 2.0", open: true, intel: 18, codingAgent: null, codingAgentVia: null, agentic: 23, vision: 74, training: null,
    note: "Meta's return to open weights, 10 August 2026, and the first Muse model with a licence that permits anything: Apache 2.0, after three closed Muse Spark releases. Built to run locally rather than to top a leaderboard — a dense 30B including its vision tower, quantised to roughly 4 bits so the language model, the KV cache, the perception encoder and a speculative drafter all fit inside a 24GB card. Attention repeats three sliding-window layers to one global, at a 2,048-token window. Weights ship in several formats from the same repository: BF16 for research, GGUF for llama.cpp, and ExecuTorch builds for on-device use. Artificial Analysis rates it 18 on intelligence, 23 on agentic and 74 on vision, from the high reasoning-effort row. The layer and head figures widely reported for it are not recorded here, because no one has read them off the config.json for this atlas yet." },
