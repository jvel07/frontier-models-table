...
export const MODELS = [
  ...
  { name: "Sarvam 105B", provider: "Sarvam AI", released: "2026/03", type: "Mid", arch: "Sparse MoE", params: "105B", active: "10.3B",
    attn: "MLA (Multi-head Latent Attn)", modality: "Text", context: 131072, maxOut: null, license: "Apache 2.0", open: true, intel: 12, coding: null, agentic: null,
    training: [
  ...
  { name: "Sarvam 30B", provider: "Sarvam AI", released: "2026/03", type: "SLM", arch: "Sparse MoE", params: "30B", active: "2.4B",
    attn: "Grouped-query attention", modality: "Text", context: 131072, maxOut: null, license: "Apache 2.0", open: true, intel: 6, coding: null, agentic: null,
    training: [
  ...
  { name: "Kimi K2.6", provider: "Moonshot", released: "2026/04", type: "Frontier", arch: "Sparse MoE", params: "1T", active: "32B",
    attn: "MLA (Multi-head Latent Attn)", modality: "Text + image", context: 256000, maxOut: null, license: "Modified MIT", open: true, intel: 45, coding: 62, agentic: 31,
  ...
  { name: "GLM-5.1", provider: "Zhipu", released: "2026/04", type: "Frontier", arch: "Sparse MoE", params: "744B", active: "40B",
    attn: "MLA + DeepSeek Sparse Attn", modality: "Text + image", context: 202752, maxOut: null, license: "MIT", open: true, intel: 41, coding: 56, agentic: 31, training: null,
  ...
  { name: "Laguna XS.2", provider: "Poolside", released: "2026/04", type: "SLM", arch: "Sparse MoE", params: "33B", active: "3B",
    attn: "Sliding-window + global", modality: "Text", context: 131072, maxOut: null, license: "Apache 2.0", open: true, intel: null, coding: null, agentic: null,
    training: [
  ...
  { name: "Gemma 4 26B-A4B", provider: "Google", released: "2026/04", type: "SLM", arch: "Sparse MoE", params: "25.2B", active: "3.8B",
    attn: "Sliding-window + global", modality: "Text + image + video", context: 256000, maxOut: 8192, license: "Apache 2.0", open: true, intel: 26, coding: 39, agentic: 11, training: null,
  ...
  { name: "Muse Spark", provider: "Meta", released: "2026/04", type: "Frontier", arch: "Undisclosed", params: "—", active: "—",
    attn: "Undisclosed", modality: "Text + image + audio", context: 262144, maxOut: null, license: "Proprietary", open: false, intel: 44, coding: 59, agentic: null, training: null,
  ...
  { name: "Opus 5", provider: "Anthropic", released: "2026/07", type: "Frontier", arch: "Undisclosed", params: "\u2014", active: "\u2014",
    attn: "Undisclosed", modality: "Text + image", context: 1000000, maxOut: 128000, license: "Proprietary", open: false, intel: 63, coding: 78, agentic: 59, training: null,
  ...
  { name: "Sonnet 5", provider: "Anthropic", released: "2026/06", type: "Mid", arch: "Undisclosed", params: "\u2014", active: "\u2014",
    attn: "Undisclosed", modality: "Text + image", context: 1000000, maxOut: 64000, license: "Proprietary", open: false, intel: 55, coding: 72, agentic: 50, training: null,
  ...
  { name: "GPT-5.6 Sol", provider: "OpenAI", released: "2026/07", type: "Frontier", arch: "MoE (reported)", params: "\u2014", active: "\u2014",
    attn: "Undisclosed", modality: "Text + image + audio", context: 1000000, maxOut: 128000, license: "Proprietary", open: false, intel: 61, coding: 77, agentic: 58, training: null,
  ...
  { name: "GPT-5.6 Terra", provider: "OpenAI", released: "2026/07", type: "Frontier", arch: "MoE (reported)", params: "\u2014", active: "\u2014",
    attn: "Undisclosed", modality: "Text + image", context: 1000000, maxOut: 128000, license: "Proprietary", open: false, intel: 57, coding: 77, agentic: 50, training: null,
  ...
  { name: "GPT-5.6 Luna", provider: "OpenAI", released: "2026/07", type: "Mid", arch: "MoE (reported)", params: "\u2014", active: "\u2014",
    attn: "Undisclosed", modality: "Text + image", context: 1000000, maxOut: 128000, license: "Proprietary", open: false, intel: 52, coding: 71, agentic: 47, training: null,
  ...
  { name: "Grok 4.6", provider: "xAI", released: "2026/08", type: "Frontier", arch: "Undisclosed", params: "\u2014", active: "\u2014",
    attn: "Undisclosed", modality: "Text + image", context: 500000, maxOut: null, license: "Proprietary", open: false, intel: 61, coding: 77, agentic: 59, training: null,
  ...
  { name: "Grok 4.5", provider: "xAI", released: "2026/07", type: "Frontier", arch: "MoE (reported)", params: "\u2014", active: "\u2014",
    attn: "Sparse + long-context", modality: "Text + image", context: 500000, maxOut: null, license: "Proprietary", open: false, intel: 56, coding: 72, agentic: 49, training: null,
  ...
  { name: "Muse Spark 1.1", provider: "Meta", released: "2026/07", type: "Frontier", arch: "Undisclosed", params: "\u2014", active: "\u2014",
    attn: "Undisclosed", modality: "Text + image + video + audio", context: 1048576, maxOut: null, license: "Proprietary", open: false, intel: 53, coding: 71, agentic: 40, training: null,
  ...
  { name: "Muse Spark 1.2", provider: "Meta", released: "2026/08", type: "Frontier", arch: "Undisclosed", params: "—", active: "—",
    attn: "Undisclosed", modality: "Text + image + video + audio", context: 1048576, maxOut: null, license: "Proprietary", open: false, intel: 57, coding: 72, agentic: 49, training: null,
  ...
  { name: "Qwen3.8 Max", provider: "Alibaba", released: "2026/07", type: "Frontier", arch: "Sparse MoE", params: "2.4T", active: "95B",
    attn: "Gated DeltaNet + gated attn", modality: "Text + image + video", context: 1000000, maxOut: 131072, license: "Proprietary (API)", open: false, intel: 58, coding: 72, agentic: 58, training: null,
  ...
  { name: "Kimi K3", provider: "Moonshot", released: "2026/07", type: "Frontier", arch: "Sparse MoE", params: "2.8T", active: "104.2B",
    attn: "KDA + full attn (69:24 layers)", modality: "Text + image + video", context: 1048576, maxOut: 131072, license: "Kimi K3 License", open: true, intel: 60, coding: 76, agentic: 54,
    training: [
  ...
  { name: "GLM-5.2", provider: "Zhipu", released: "2026/06", type: "Frontier", arch: "Sparse MoE", params: "744B", active: "40B",
    attn: "DSA + MLA (IndexShare)", modality: "Text + image", context: 1000000, maxOut: 128000, license: "MIT", open: true, intel: 53, coding: 69, agentic: 46, training: null,
  ...
  { name: "Inkling", provider: "Thinking Machines", released: "2026/07", type: "Frontier", arch: "Sparse MoE", params: "975B", active: "41B",
    attn: "Undisclosed", modality: "Text + image + audio", context: 1000000, maxOut: null, license: "Apache 2.0", open: true, intel: 42, coding: 52, agentic: 34, training: null,
  ...
  { name: "Laguna XS 2.1", provider: "Poolside", released: "2026/07", type: "SLM", arch: "Sparse MoE", params: "33B", active: "3B",
    attn: "Sliding-window + global", modality: "Text", context: null, maxOut: null, license: "OpenMDW-1.1", open: true, intel: null, coding: null, agentic: null, training: null,
  ...
  { name: "Fable 5", provider: "Anthropic", released: "2026/06", type: "Frontier", arch: "Undisclosed", params: "—", active: "—",
    attn: "Undisclosed", modality: "Text + image", context: 1000000, maxOut: 128000, license: "Proprietary", open: false, intel: 62, coding: 76, agentic: 57, training: null,
  ...
  { name: "Opus 4.8", provider: "Anthropic", released: "2026/05", type: "Frontier", arch: "Undisclosed", params: "—", active: "—",
    attn: "Undisclosed", modality: "Text + image", context: 1000000, maxOut: 64000, license: "Proprietary", open: false, intel: 57, coding: 74, agentic: 49, training: null,
  ...
  { name: "Sonnet 4.6", provider: "Anthropic", released: "2026/02", type: "Frontier", arch: "Undisclosed", params: "—", active: "—",
    attn: "Undisclosed", modality: "Text + image", context: 1000000, maxOut: 64000, license: "Proprietary", open: false, intel: 48, coding: 63, agentic: 42, training: null,
  ...
  { name: "Haiku 4.5", provider: "Anthropic", released: "2025/10", type: "Mid", arch: "Undisclosed", params: "—", active: "—",
    attn: "Undisclosed", modality: "Text + image", context: 200000, maxOut: 64000, license: "Proprietary", open: false, intel: 30, coding: 44, agentic: 16, training: null,
  ...
  { name: "GPT-5.5", provider: "OpenAI", released: "2026/04", type: "Frontier", arch: "MoE (reported)", params: "—", active: "—",
    attn: "Undisclosed", modality: "Text + image + audio", context: 922000, maxOut: 128000, license: "Proprietary", open: false, intel: 56, coding: 75, agentic: 47, training: null,
  ...
  { name: "GPT-5 mini", provider: "OpenAI", released: "2025/08", type: "Mid", arch: "MoE (reported)", params: "—", active: "—",
    attn: "Undisclosed", modality: "Text + image", context: 400000, maxOut: 64000, license: "Proprietary", open: false, intel: 32, coding: 16, agentic: 20, training: null,
  ...
  { name: "Gemini 3.1 Pro", provider: "Google", released: "2026/02", type: "Frontier", arch: "MoE (reported)", params: "—", active: "—",
    attn: "Sparse + long-context", modality: "Text + image + video + audio", context: 1000000, maxOut: 64000, license: "Proprietary", open: false, intel: 48, coding: 69, agentic: 23, training: null,
  ...
  { name: "Gemini 3.7 Flash", provider: "Google", released: "2026/08", type: "Mid", arch: "MoE (reported)", params: "—", active: "—",
    attn: "Sparse + long-context", modality: "Text + image + video + audio", context: 1000000, maxOut: 64000, license: "Proprietary", open: false, intel: 56, coding: 76, agentic: 45, training: null,
  ...
  { name: "Gemini 3.6 Flash", provider: "Google", released: "2026/07", type: "Mid", arch: "MoE (reported)", params: "—", active: "—",
    attn: "Sparse + long-context", modality: "Text + image + video + audio", context: 1000000, maxOut: 64000, license: "Proprietary", open: false, intel: 52, coding: 69, agentic: 41, training: null,
  ...
  { name: "Gemini 3.5 Flash", provider: "Google", released: "2026/05", type: "Mid", arch: "MoE (reported)", params: "—", active: "—",
    attn: "Sparse + long-context", modality: "Text + image + audio", context: 1000000, maxOut: 64000, license: "Proprietary", open: false, intel: 52, coding: 70, agentic: 40, training: null,
  ...
  { name: "Grok 4.3", provider: "xAI", released: "2026/04", type: "Frontier", arch: "MoE (reported)", params: "—", active: "—",
    attn: "Sparse + long-context", modality: "Text + image", context: 1000000, maxOut: 64000, license: "Proprietary", open: false, intel: 38, coding: 42, agentic: 24, training: null,
  ...
  { name: "MiniMax M3", provider: "MiniMax", released: "2026/06", type: "Frontier", arch: "Sparse MoE", params: "428B", active: "—",
    attn: "MSA sparse attention", modality: "Text + image + video", context: 1000000, maxOut: 64000, license: "Proprietary", open: false, intel: 45, coding: 59, agentic: 36, training: null,
  ...
  { name: "Mistral Large 3", provider: "Mistral", released: "2025/12", type: "Frontier", arch: "Sparse MoE", params: "673B", active: "41B",
    attn: "MLA (Multi-head Latent Attn)", modality: "Text + image", context: 262144, maxOut: 64000, license: "Apache 2.0", open: true, intel: 16, coding: 20, agentic: 6, training: null,
  ...
  { name: "GLM-5", provider: "Zhipu", released: "2026/02", type: "Frontier", arch: "Sparse MoE", params: "744B", active: "40B",
    attn: "MLA + DeepSeek Sparse Attn", modality: "Text + image", context: 202752, maxOut: 32000, license: "MIT", open: true, intel: 41, coding: null, agentic: null,
    training: [
  ...
  { name: "Command A", provider: "Cohere", released: "2025/03", type: "Mid", arch: "Dense", params: "111B", active: "111B",
    attn: "Grouped-query attention", modality: "Text", context: 256000, maxOut: 32000, license: "CC-BY-NC", open: true, intel: 7, coding: null, agentic: null,
    training: [
  ...
  { name: "Nemotron 3 Ultra", provider: "NVIDIA", released: "2026/06", type: "Frontier", arch: "Sparse MoE", params: "550B", active: "55B",
    attn: "Mamba-2 SSM + GQA attn", modality: "Text", context: 262144, maxOut: 32000, license: "NVIDIA Nemotron Open Model License", open: true, intel: 38, coding: 49, agentic: 27, training: [{ label: "Pre-training P1", tokens: "15T", detail: "Diversity-focused mixture (web, code, math, multilingual); NVFP4 training, LatentMoE, multi-token prediction." }, { label: "Pre-training P2", tokens: "5T", detail: "Quality-focused high-fidelity data after ~75% of pretraining (20T total text tokens)." }, { label: "Context extension", tokens: null, detail: "Extends context to 1M tokens via continued pretraining." }, { label: "SFT + RL + MOPD", tokens: null, detail: "Supervised fine-tuning, multi-environment RLVR, and Multi-teacher On-Policy Distillation." }],
  ...
  { name: "Muse Glimmer", provider: "Meta", released: "2026/08", type: "SLM", arch: "Dense", params: "30B", active: "30B",
    attn: "Sliding-window + global", modality: "Text + image", context: 131072, maxOut: null, license: "Apache 2.0", open: true, intel: 35, coding: 49, agentic: 23, training: null,
  ...
  { name: "Gemma 4 E4B", provider: "Google", released: "2026/04", type: "SLM", arch: "Dense", params: "8B (4.5B eff.)", active: "8B (4.5B eff.)",
    attn: "Sliding-window + global", modality: "Text + image + video + audio", context: 128000, maxOut: 8192, license: "Apache 2.0", open: true, intel: 12, coding: 9, agentic: null, training: [{ label: "Pre-training", tokens: null, detail: "Distillation-based pretraining at edge scale (token budget not separately published)." }, { label: "Post-training", tokens: null, detail: "Instruction tuning + RLHF; adds audio input." }],
  ...
  { name: "Gemma 3 4B", provider: "Google", released: "2025/03", type: "SLM", arch: "Dense", params: "4B", active: "4B",
    attn: "Sliding-window + global", modality: "Text + image", context: 128000, maxOut: 8192, license: "Gemma", open: true, intel: 1, coding: 3, agentic: null, training: [{ label: "Pre-training", tokens: "4T", detail: "Knowledge-distillation pretraining (Gemma 3 report: 4T tokens for the 4B model)." }, { label: "Post-training", tokens: null, detail: "Distillation, SFT, and RLHF." }],
  ...
  { name: "FunctionGemma 270M", provider: "Google", released: "2026/04", type: "SLM", arch: "Dense", params: "0.27B", active: "0.27B",
    attn: "Sliding-window + global", modality: "Text", context: 32000, maxOut: 4096, license: "Gemma", open: true, intel: null, coding: null, agentic: null, training: [{ label: "Pre-training", tokens: null, detail: "Small-scale distillation pretraining (budget not published)." }, { label: "Task fine-tuning", tokens: null, detail: "Specialized for function calling." }],
  ...
  { name: "Fara 1.5 4B", provider: "Microsoft", released: "2026/05", type: "SLM", arch: "Dense", params: "4B", active: "4B",
    attn: "Gated DeltaNet + gated attn", modality: "Text + image", context: 262144, maxOut: null, license: "MIT", open: true, intel: null, coding: null, agentic: null, training: [{ label: "Supervised fine-tuning", tokens: null, detail: "Same FaraGen1.5 trajectory data as the 27B, fine-tuned onto Qwen3.5-4B instead. Microsoft reports 32 NVIDIA B200s for two days; no token count is published." }],
  ...
  { name: "Qwen3.5 (0.8B)", provider: "Alibaba", released: "2026/02", type: "SLM", arch: "Dense", params: "0.8B", active: "0.8B",
    attn: "Gated DeltaNet + gated attn", modality: "Text + image + video", context: 262144, maxOut: 8192, license: "Apache 2.0", open: true, intel: 5, coding: 0, agentic: null, training: [{ label: "Pre-training", tokens: null, detail: "Alibaba published no Qwen3.5 technical report. The only official source is the Qwen3.5 blog (\"Towards Native Multimodal Agents\", Feb 2026), which names the training stages but discloses no token budget for any of them — so no figure is shown here rather than borrowing the previous generation's." }, { label: "Post-training", tokens: null, detail: "SFT + RL; thinking/non-thinking modes." }],
  ...
  { name: "Llama 3.2 1B", provider: "Meta", released: "2024/09", type: "SLM", arch: "Dense", params: "1B", active: "1B",
    attn: "Grouped-query attention", modality: "Text", context: 128000, maxOut: 8192, license: "Llama 3.2 Community", open: true, intel: 1, coding: null, agentic: null, training: [{ label: "Pre-training", tokens: "Up to 9T", detail: "Pruned + distilled from Llama 3.1 8B/larger teachers." }, { label: "Post-training", tokens: null, detail: "SFT + DPO alignment." }],
  ...
  { name: "Mistral Small 4", provider: "Mistral", released: "2026/03", type: "SLM", arch: "Sparse MoE", params: "119B", active: "6.63B",
    attn: "MLA (Multi-head Latent Attn)", modality: "Text + image", context: 256000, maxOut: 16000, license: "Apache 2.0", open: true, intel: 20, coding: 27, agentic: 5, training: null,
  ...
  { name: "Leanstral 1.5", provider: "Mistral", released: "2026/07", type: "SLM", arch: "Sparse MoE", params: "119B", active: "6.5B",
    attn: "MLA (Multi-head Latent Attn)", modality: "Text + image", context: 256000, maxOut: null, license: "Apache 2.0", open: true, intel: null, coding: null, agentic: null, training: null,
  ...
  { name: "Granite SWASH 2B", provider: "IBM", released: "2026/07", type: "SLM", arch: "Dense", params: "2.14B", active: "2.14B",
    attn: "Sliding-window + attention sinks", modality: "Text", context: 8192, maxOut: null, license: "Apache 2.0", open: true, intel: null, coding: null, agentic: null, training: null,
  ...
  { name: "Tiny Aya", provider: "Cohere", released: "2026/02", type: "SLM", arch: "Dense", params: "3.35B", active: "3.35B",
    attn: "Sliding-window + global", modality: "Text", context: 8192, maxOut: 4096, license: "CC-BY-NC", open: true, intel: 1, coding: null, agentic: null, training: null,
  ...
  { name: "Qwen3 235B-A22B", provider: "Alibaba", released: "2025/04", type: "Frontier", arch: "Sparse MoE", params: "235B", active: "22B",
    attn: "Grouped-query attention", modality: "Text", context: 131072, maxOut: null, license: "Apache 2.0", open: true, intel: 13, coding: null, agentic: null,
    training: [
  ...
  { name: "Qwen3-VL 235B-A22B", provider: "Alibaba", released: "2025/09", type: "Frontier", arch: "Sparse MoE", params: "235B", active: "22B",
    attn: "Grouped-query attention", modality: "Text + image + video", context: 262144, maxOut: null, license: "Apache 2.0", open: true, intel: 21, coding: null, agentic: null,
    training: [
...
export const PRESETS = {
  All: null,
  Serving: ["name", "intel", "coding", "agentic", "params", "active", "context", "maxOut", "license"],
 ...
 * thresholds — a reader comparing Intelligence against Agentic is comparing bars
 * drawn to the same scale. A blank is an em dash, never a zero-width bar: the
 * score is absent, not low.
 */
...
export default function FrontierModelsTable({ focus } = {}) {
  ...
  const rows = useMemo(() => {
    ...
    r = [...r].sort((a, b) => {
      ...
      else if (sortKey === "intel" || sortKey === "coding" || sortKey === "agentic") {
        av = a[sortKey] == null ? -1 : a[sortKey];
        bv = b[sortKey] == null ? -1 : b[sortKey];
      }
    ...
    <div style={S.page}>
      <div style={S.shell}>
        ...
        <footer style={{ ...S.footer, paddingBottom: selected.length > 0 ? 96 : undefined }}>
          ...
          <span>Intelligence = Artificial Analysis Intelligence Index v4.1, leaderboard snapshot 15 August 2026 (artificialanalysis.ai). v4.1 combines 9 evaluations: GDPval-AA v2, 𝜏³-Banking, Terminal-Bench v2.1, SciCode, Humanity's Last Exam, GPQA Diamond, CritPt, AA-Omniscience and AA-LCR. Where AA lists several reasoning-effort variants, the highest-scoring variant is shown, per index rather than per model: AA scores some variants on one index and not another, so a model's three figures can come from different effort settings. Coding and Agentic are the 16 August 2026 snapshot, one day later than Intelligence; "—" = not on the AA leaderboard.</span>
          <span>Coding = Artificial Analysis Coding Index, leaderboard snapshot 16 August 2026, which combines Terminal-Bench v2.1 and SciCode into a single 0-100 score. It measures coding alone and is reported separately from the Intelligence Index, so a model can sit well above or below its overall position. As with Intelligence, where AA lists several reasoning-effort variants the highest-scoring one is shown. This is not AA's Coding Agent Index, which scores a model paired with a specific harness (Cursor CLI, Codex, Claude Code) rather than the model on its own; "—" = not on the AA coding leaderboard. Where AA carries dated checkpoint rows for one model — DeepSeek V4 Pro 0813, V4 Flash 0731 — the checkpoint whose Intelligence figure this table already records is the one read, so a row's three scores describe one checkpoint rather than two.</span>
